...

    {
        ...
        /*stdClass Object ( 
            [message] => stdClass Object ( 
                [u] => stdClass Object ( 
                    [_id] => eCeiMr9YcobizQha6 
                ) 
                [rid] => rB5TJAcxYPf99anYT 
                [_id] => fmSvPRsXK98b6tPYQ 
            )
        ) */
        //die(print_r($result->message->_id));
        return $result->message->_id;
    }

    public function deleteChannel_msg($id, $mid)

    {
        $result = $this->post('chat.delete', ['roomId' => $id, 'msgId' => $mid]);
        return $result;
    }
