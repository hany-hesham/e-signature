	...
	<div class="container">
		<div class="rest-selector col-lg-12 col-md-12 col-sm-12 col-xs-12 non-printable">
			...
			<legend class="title-table">Amenity summary</legend>
					<?php $this->load->view('amenity_type_report_menu_hotel'); ?>
			</fieldset>
		</div>
		<?php if (isset($amenity)): ?>	
			...
			<h2 class="centered topic" style="display: none;"> Amenities summary of Type <?php echo $type; ?> </h2>
			...
			<?php foreach ($amenity as $amenit): ?>
				...
				<?php endforeach ?>
			<?php endforeach ?>
			<h4 class="centered"> Total of <?php echo $del; ?> Amenities Marked as <?php echo $type; ?></h4>
			<br>
			<div class="centered">
