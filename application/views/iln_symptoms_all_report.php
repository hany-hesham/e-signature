    ...
    <a class="form-actions btn btn-success non-printable" href="/qlt_report" style="float:right;" > Back </a>
		<div class="rest-selector col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <legend class="title-table non-printable">Illness Log Report</legend>
                    <?php $this->load->view('iln_report_menu_symptoms_all'); ?>
            </fieldset>
        </div>
        <?php if (isset($illness)): ?>  
            <div class="centered">
                <h1 class="centered topic" style="display: none;"> Illness Log Report </h1>
                <h2 class="centered topic" style="display: none;"> for Diagnosis / Symptoms <?php echo $symptoms; ?> </h2>
                <?php $counter = 0; ?>
