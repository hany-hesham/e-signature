  ...
  <body>
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse" id="forms-subnav">
        <ul class="nav navbar-nav navbar-left navbar-user">
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'frontoffice')? 'active' : '' ?>"><a href="/change/index">All</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'frontoffice')? 'active' : '' ?>"><a href="/change/index_app">Approved</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'frontoffice')? 'active' : '' ?>"><a href="/change/index_wat">Waiting Approval</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'frontoffice')? 'active' : '' ?>"><a href="/change/index_rej">Rejected</a></li>
        </ul>
      </nav>
        <div id="page-wrapper">
          <a href="<?php echo base_url(); ?>change/add/" class="btn btn-info">New Rate Change Request Form</a>
          <br>
          <br>
          <div class="rest-selector col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <fieldset>
              <?php $this->load->view('change_waiting_menu'); ?>
            </fieldset>
          </div>
          <?php if (isset($state)): ?> 
            <?php if ($state == 0) {   ?>
        ...
        <table class="table table-bordered table-hover table-striped tablesorter">
          <thead>
            <tr>
              ...
              <th class="header">Old Room<i class="fa fa-sort"></i></th>
              <th class="header">New Room<i class="fa fa-sort"></i></th>
              <th class="header">Action<i class="fa fa-sort"></i></th>
              <th class="header">Status<i class="fa fa-sort"></i></th>
            </tr>
          </thead>
          <tbody>
            <?php foreach($change as $forma ){?>
            ...
            <tr class="active">
              ...
              <td><?php echo $forma['room_old'] ?></td>
              <td><?php echo $forma['room_new'] ?></td>
              <td>
                <a href="<?php echo base_url(); ?>change/view/<?php echo $forma['id'] ?> " class="btn btn-primary" style="width: 80px;">View</a>
              </td>
      ...
      <?php }elseif ($state == 4) {   ?>
        ...
        <table class="table table-bordered table-hover table-striped tablesorter">
          ...
          <tbody>
            <?php foreach($change as $forma ){?>
              <?php if ($forma['guest'] != NULL && $forma['state_id'] =='6'){?>
      ...
      <?php }elseif ($state == 5) {   ?>
        ...
        <table class="table table-bordered table-hover table-striped tablesorter">
          ...
          <tbody>
            <?php foreach($change as $forma ){?>
              <?php if ($forma['guest'] != NULL && $forma['state_id'] =='7'){?>
    ...
    <script type="text/javascript">
      $(function(){
        ...
        .find(".tablesorter-filter-row td:last input").replaceWith('<a href="<?php echo base_url(); ?>change/" class="reset-filters btn btn-warning">Reset</a>');
      });
    </script>
  </body>
</html>
