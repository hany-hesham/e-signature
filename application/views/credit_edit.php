                ...
                <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                  <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                    ...
                    <select class="form-control chooosen" data-placeholder="Hotel ..." name="hotel_id" id="from-hotel " style="width: 250px; height:33px;">
                      <option data-company="0" value="<?php echo $credit['hotel_id'] ?>"><?php echo $credit['hotel_name'] ?></option>
                  ...
                  <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                    ...
                    <div class='input-group date' id='datetimepicker1' style="width: 250px; height:33px;">
                      <input type='text' class="form-control" name="date" value="<?php echo $credit['date'] ?>"/>
                  ...
                  <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                    ...
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                      ...
                      <input type="text" class="form-control" name="company" placeholder="Company ..." value="<?php echo $credit['company'] ?>" style="width: 250px; height:33px;"/></input>
                    </div>
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                      <br>
                      <label for="from-hotel" class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label" style="margin-top:5px;"> Address</label>
                      <input type="text" class="form-control" name="address" placeholder="Address ..." value="<?php echo $credit['address'] ?>" style="width: 250px; height:33px;"/></input>
                    </div>
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                      <br>
                      <label for="from-hotel" class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label" style="margin-top:5px;">Contact Person</label>
                      <input type="text" class="form-control" name="person" placeholder="Contact ..." value="<?php echo $credit['person'] ?>" style="width: 250px; height:33px;"/></input>
                    </div>
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                      <br>
                      <label for="from-hotel" class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label" style="margin-top:5px;">Telephone</label>
                      <input type="number" class="form-control" name="tele" placeholder="Telephone ..." value="<?php echo $credit['tele'] ?>" style="width: 250px; height:33px;"/></input>
                    </div>
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                      <br>
                      <label for="from-hotel" class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label" style="margin-top:5px;">E-mail</label>
                      <input type="text" class="form-control" name="email" placeholder="E-mail ..." value="<?php echo $credit['email'] ?>" style="width: 250px; height:33px;"/></input>
                    </div>
                  </div>
                  <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                    <br>
                    ...
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                      ...
                      <div class='input-group date' id='datetimepicker2' style="width: 250px; height:33px;">
                        <input type='text' class="form-control" name="period_from" value="<?php echo $credit['period_from'] ?>"/>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                      </div>
                      <br>
                      ...
                      <div class='input-group date' id='datetimepicker3' style="width: 250px; height:33px;">
                        <input type='text' class="form-control" name="period_to" value="<?php echo $credit['period_to'] ?>"/>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                      </div>
                    </div>
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                      ...
                      <input type="number" class="form-control" name="rooms" placeholder="Rooms ..." value="<?php echo $credit['rooms'] ?>" style="width: 250px; height:33px;"/></input>
                    </div>
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                      <br>
                      <label for="from-hotel" class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label" style="margin-top:5px;">Type</label>
                      <input type="text" class="form-control" name="contract_type" placeholder="Type ..." value="<?php echo $credit['contract_type'] ?>" style="width: 250px; height:33px;"/></input>
                    </div>
                  </div>
                  <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                    <br>
                    ...
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                      ...
                      <input type="number" class="form-control" name="cash" placeholder="Amount ..." value="<?php echo $credit['cash'] ?>" style="width: 250px; height:33px;"/></input>
                    </div>
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                      <br>
                      ...
                      <select class="orm-control chooosen" name="currency" data-placeholder="Currency ..." style="width: 250px;">
                        <option value="<?php echo $credit['currency'] ?>"><?php echo $credit['currency'] ?></option>
                    ...
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                      ...
                      <input type="text" class="form-control" name="letter" placeholder="Guarantee ..." value="<?php echo $credit['letter'] ?>" style="width: 250px; height:33px;"/></input>
                    </div>
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                      <br>
                      ...
                      <div class='input-group date' id='datetimepicker4' style="width: 250px; height:33px;">
                        <input type='text' class="form-control" name="renew_date" value="<?php echo $credit['renew_date'] ?>"/>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                      </div>
                    </div>
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                      ...
                      <input type="text" class="form-control" name="method" placeholder="Deposit Deduction ..." value="<?php echo $credit['method'] ?>" style="width: 250px; height:33px;"/></input>
                    </div>
                  </div>
                  <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                    <br>
                    ...
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                      ...
                      <input type="number" class="form-control" name="limits" placeholder="Amount ..." value="<?php echo $credit['limits'] ?>" style="width: 250px; height:33px;"/></input>
                    </div>
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                      <br>
                      <label for="from-hotel" class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label" style="margin-top:5px;"> Currency</label>
                      <select class="orm-control chooosen" name="currency1" data-placeholder="Currency ..." style="width: 250px;">
                        <option value="<?php echo $credit['currency1'] ?>"><?php echo $credit['currency1'] ?></option>
                    ...
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                      ...
                      <textarea type="text" name="note" class="form-control" rows="3" placeholder="Notes..." style="width: 350px;"><?php echo $credit['note'] ?></textarea>
                    </div>
                  </div>
                  <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                    <br>
                    ...
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                      ...
                      <textarea type="text" name="terms" class="form-control" rows="3" placeholder="Terms..." style="width: 350px;"><?php echo $credit['terms'] ?></textarea>
                    </div>
                  </div>
                  <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                    <br>
                    ...
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                      ...
                      <input type="text" class="form-control" name="ability" placeholder="Ability ..." value="<?php echo $credit['ability'] ?>" style="width: 250px; height:33px;"/></input>
                    </div>
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                      <br>
                      <label for="from-hotel" class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label" style="margin-top:5px;">Other Remarks</label>
                      <textarea type="text" name="remarks" class="form-control" rows="3" placeholder="Remarks..." style="width: 350px;"><?php echo $credit['remarks'] ?></textarea>
                    </div>
                  </div>
                  <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                    <br>
                    ...
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                      ...
                      <textarea type="text" name="nb" class="form-control" rows="3" placeholder="NB..." style="width: 350px;"><?php echo $credit['nb'] ?></textarea>
                    </div>
                  </div>
                  <div class="form-group col-lg-10 col-md-10 col-sm-10 col-xs-10">
                    ...
                    <script>
                      $("#offers").fileinput({
                        uploadUrl: "/credit/upload/<?php echo $credit['id'] ?>",
                        uploadAsync: true,
                        minFileCount: 1,
                        maxFileCount: 100,
                        ...
                        initialPreviewConfig: [
                          <?php foreach($uploads as $upload): ?>
                            {url: "/credit/remove/<?php echo $credit['id'] ?>/<?php echo $upload['id'] ?>", key: "<?php echo $upload['name']; ?>"},
                          <?php endforeach; ?>
                        ],
                      });
                    </script>
                  ...
                  <div style="margin-top: 90px;" class="form-group">
                    <div class="col-lg-offset-3 col-lg-10 col-md-10 col-md-offset-3">
                      ...
                      <a href="<?= base_url(); ?>credit/view/<?php echo $credit['id'] ?>" class="btn btn-warning">Cancel</a>
                    </div>
                  </div>
                </div>
              </form>
