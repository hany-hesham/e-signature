	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 non-printable">
	    ...
	    <div class="col-lg-offset-3 col-lg-3 col-md-6 col-md-offset-3 col-sm-3 col-sm-offset-3 col-xs-3 col-xs-offset-3">
				<select class="form-control" name="state" id="state">
					...
					<option value="2">Waiting approval from Front Office</option>
					<option value="7">Waiting approval from Hotel GM</option>
					<option value="3">Waiting approval from Food & Beverage </option>
					<option value="4">Waiting approval from Kitchen</option>
					<option value="5">Waiting approval from House Keeping</option>
					<option value="6">Waiting approval from Cost Controller</option>
				</select>
			</div>
	</div>
	<BR/><BR/>
