  ...
  <body>
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse" id="forms-subnav" style=" margin-left: 50px;">
        <ul class="nav navbar-nav navbar-left navbar-user" style="width: 370px;">
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'frontoffice')? 'active' : '' ?>"><a href="/discrepancy">All</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'frontoffice')? 'active' : '' ?>"><a href="/discrepancy/index_app">Approved</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'frontoffice')? 'active' : '' ?>"><a href="/discrepancy/index_wat">Waiting Approval</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'frontoffice')? 'active' : '' ?>"><a href="/discrepancy/index_rej">Rejected</a></li>
        </ul>
      </nav>
        <div id="page-wrapper">
          <a href="<?php echo base_url(); ?>discrepancy/submit/" class="btn btn-info">New Discrepancy Report</a>
          <br>
          <br>
          <div class="rest-selector col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <fieldset>
              <?php $this->load->view('discrepancy_waiting_menu'); ?>
            </fieldset>
          </div>
          <?php if (isset($state)): ?> 
            <?php if ($state == 0) {   ?>
        ...
        <table class="table table-bordered table-hover table-striped tablesorter">
          <thead>
            <tr>
              ...
              <th class="header">Clock system<i class="fa fa-sort"></i></th>
          ...
          <tbody>
            <?php foreach($discrepancy as $forma ){?>
            ...
            <tr class="active">
              ...
              <td>
                ...
                <?php endforeach ?>
                <?php }else{  ?>
                <h5 style="font-weight: bold;">NO DISCREPANCY</h5>
                <?php } ?>
              </td>
              <td><a href="<?php echo base_url(); ?>discrepancy/view/<?php echo $forma['id'] ?> " class="btn btn-primary">View</a></td>
              <td>
    ...
    <script type="text/javascript">
      $(function(){
        ...
        .find(".tablesorter-filter-row td:last input").replaceWith('<a href="<?php echo base_url(); ?>discrepancy/" class="reset-filters btn btn-warning">Reset</a>');
      });
    </script>
  </body>
</html>
