    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse" id="forms-subnav">
        <ul class="nav navbar-nav navbar-left navbar-user">
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'rr_change')? 'active' : '' ?>"><a href="/rr_change">All</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'rr_change')? 'active' : '' ?>"><a href="/rr_change/index_room">Change Room</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'rr_change')? 'active' : '' ?>"><a href="/rr_change/index_rate">Change Rate</a></li>
        </ul>
      </nav>
        <div id="page-wrapper">
