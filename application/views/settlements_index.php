...
<html lang="en">
  ...
  <body>
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <a href="<?php echo base_url(); ?>settlement/" class="btn btn-primary" style="float: right;">old settlements</a>
          ...
          <tbody>
            <?php foreach($settlements as $forma ) :?>
              <tr class="active">
                ...
                <td><?php echo $forma['final_settlement']." ". $forma['final_settlement_currency'] ?></td>
