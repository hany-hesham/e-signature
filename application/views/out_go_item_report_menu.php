<form action="" method="POST" id="form-submit" class="form-div span12" accept-charset="utf-8" enctype="multipart/form-data">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 non-printable">
		<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
			<select class="form-control chooosen" name="item" id="item" data-placeholder="Items ...">
				<option value="">Select Item</option>
				<?php foreach ($out_gos as $out_go): ?>
					<option value="<?php echo $out_go['description'] ?>"<?php echo set_select('item', $out_go['description']); ?>><?php echo $out_go['description']; ?></option>
				<?php endforeach ?>
			</select>
		</div>
