      ...
      <div id="page-wrapper">
        <div class="container">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <fieldset>
              <legend>Submit a new Food & Beverage Order</legend>
              ...
              <form action="" method="POST" id="form-submit" enctype="multipart/form-data" class="form-div span12" accept-charset="utf-8">
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <script>
                      $("#offers").fileinput({
                        uploadUrl: "/fb_order/make_offer/<?php echo $assumed_id; ?>", // server upload action
                        uploadAsync: true,
                        minFileCount: 1,
                        maxFileCount: 5,
                        ...
                        initialPreviewConfig: [
                          <?php foreach($uploads as $upload): ?>
                            {url: "/fb_order/remove_offer/<?php echo $assumed_id; ?>/<?php echo $upload['id']; ?>", key: "<?php echo $upload['name']; ?>"},
                          <?php endforeach; ?>
                        ],
                      });
                    </script>
