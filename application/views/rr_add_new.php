      ...
      <div id="page-wrapper">
        <div class="container">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <fieldset>
              ...
              <?php endif ?>
              <a href="<?= base_url(); ?>rr_change/no_rr/" class="btn btn-warning">No Room Change Report</a>
                  ...
                  <table class="table table-striped table-bordered table-condensed" style="width: 1200px;">
                    <thead>
                      <tr>
                        ...
                        <th colspan="1" rowspan="2" style=" text-align: center;">actoins</th>
                      </tr>
                      <tr>
                      ...
                      <tbody id="items-container" data-items="1">
                        <tr id="item-1">
                          ...
                          <td class="centered" style="width: 200px;"> 
                            <input type="text" class="form-control" name="items[1][r_from]"  id="item-1-r_from" style="width: 200px; height:35px;"/></input>
                          </td>
                          <td class="centered" style="width: 200px;"> 
                            <input type="text" class="form-control" name="items[1][r_to]"  id="item-1-r_to" style="width: 200px; height:35px;"/></input>
                          </td>
                          <td class="centered" style="width: 200px;"> 
        ...
        document.items = <?php echo json_encode($this->input->post('items')); ?>;
                  ...
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <script>
                      $("#offers").fileinput({
                        uploadUrl: "/rr_change/make_offer/<?php echo $assumed_id; ?>", // server upload action
                        uploadAsync: true,
                        minFileCount: 1,
                        maxFileCount: 5,
                        ...
                        initialPreviewConfig: [
                          <?php foreach($uploads as $upload): ?>
                            {url: "/rr_change/remove_offer/<?php echo $assumed_id; ?>/<?php echo $upload['id']; ?>", key: "<?php echo $upload['name']; ?>"},
                          <?php endforeach; ?>
                        ],
                      });
                    </script>
