	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 non-printable">
	    <div class="col-lg-offset-3 col-lg-3 col-md-6 col-md-offset-3 col-sm-3 col-sm-offset-3 col-xs-3 col-xs-offset-3">
				<select class="form-control chooosen" required name="state" data-placeholder="Signature ..." style="width: 400px;">
					<option></option>
					<option value="1">Waiting approval from أ / عبد الحميد صالح</option>
					<option value="4">Waiting approval from أ / جاسر بهجت </option>
					<option value="5">Waiting approval from رئيس مجلس الأدارة </option>
				</select>
			</div>
	</div>
	<BR/><BR/>
