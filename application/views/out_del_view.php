    	...
    	<div id="wrapper">
      		...
      		<div id="page-wrapper">
        		<div class="a4wrapper">
          			<div class="a4page">
            			<div>
              				<div class="page-header">
								...
								<?php if ($is_editor): ?>
									<a class="form-actions btn btn-info non-printable" href="/out_go_deliver/edit/<?php echo $item['id'] ?>" style="float:right;" > Edit </a>
								<?php endif ?>
			        			...
			        			<h3 class="centered">
			        				Out Going Delivery Report No. #<?php echo $item['id']; ?> For Item <?php echo $item['description']; ?>
			        			</h3>
			        			<a class="form-actions btn btn-info non-printable" href="/out_go_deliver/mail_me/<?php echo $item['id'] ?>" style="float:left; margin-left: 20px;" > <img src="/assets/images/letter.png" style="width: 28px; height: 40px; margin: 0px; margin-left: -10px; margin-top: -10px; margin-bottom: -10px;"> Share by Email </a>
								<a data-text="whatsapp" data-link="<?php echo base_url(); ?>out_go_deliver/view/<?php echo $item['id'] ?>" style="float:left; margin-left: 20px;" class="whatsapp whatsapp_btn whatsapp_btn_small form-actions btn btn-success non-printable"> <img src="/assets/images/original.png" style="width: 70px; height: 50px; margin: -20px; margin-left: -30px; margin-top: -21px;"> Share by Whatsapp</a> 
								<a class="form-actions btn btn-success non-printable" href="/out_go/view/<?php echo $out_go['id']; ?>" style="float:right;"> Back </a>
			        			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 data-catcher data-indention">
			        				<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                  					<label for="from-hotel" class="control-label " style="width: 160px;"> Date of Return: </label>
	                  					<label for="from-type" class="control-label " style="width:200px;"><?php echo $item['del_date'] ?></label>
	                  				</div>
				        			<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                  					<label for="from-hotel" class="control-label " style="width: 160px;"> Statuse Report: </label>
	                  					<label for="from-type" class="control-label " style="width:200px;"><?php echo $item['report'] ?></label>
	                  				</div>
	                  				<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<br>
	                  					<label for="from-hotel" class="control-label " style=" width:160px;"> Out With: </label>
	                  					<label for="from-type" class="control-label " style=" width:500px; color: blue;"><?php echo $out_go['out_with'] ?>  (<span style="color: red">assigned by <?php echo $out_go['name'];?></span>)</label>
	                  				</div>
	                  			</div>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 data-catcher centered">
				                ...
				                <?php foreach ($signers as $signe_id => $signer): ?>
				                	<div class="signature-wrapper">
				                    		...
				                    		<div class="expander-wrapper">
				                      			...
				                      			<div class="expander">
				                        			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 data-holder">
				                          				<div class="row">
				                            				<form action="/out_go_deliver/mail/<?php echo $item['id']; ?>" method="POST" id="form-submit" class="form-div span12" accept-charset="utf-8">
				                  		...
				                  		<?php if (isset($signer['sign'])): ?>
				                  			<div class="data-content"><img src="<?php echo isset($signer['sign']['reject'])? $signature_path.'rejected.png' : $signature_path.'approved.png'; ?>" alt="<?php echo $signer['sign']['name']; ?>" class="img-rounded sign-image">
				                    			<?php if (($signer['sign']['id'] == $user_id && $unsign_enable) || $is_admin): ?>
				                    				<a href="/out_go_deliver/unsign/<?php echo $signe_id; ?>" class="non-printable btn btn-primary unsign">Cancel</a>
				                    			<?php endif ?>
				                  			</div>
				                  		...
				                  		<?php elseif (array_key_exists($user_id, $signer['queue']) && $queue_first): ?>
				                  			...
				                  			<div class="data-content non-printable"><span class="data-label sign-data-content"></span><a href="/out_go_deliver/sign/<?php echo $signe_id; ?>/reject" class="non-printable btn btn-danger">Reject</a><a href="/out_go_deliver/sign/<?php echo $signe_id; ?>" class="non-printable btn btn-success">sign</a></div>
				                  		<?php else: ?>
				                  			<?php $queue_first = FALSE; ?>
				                  		<?php endif ?>
				                	</div>
				                ...
				                <div class="signature-wrapper">
				                  	...
				                  	<div class="data-content" style="margin-top: 30px;">
				                  		...
				                  		<br />
				                  		<span class="timestamp-data-content"><?php echo "assigned by".$out_go['name']; ?></span>
				                  	</div>
				                </div>
				            </div>
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 data-catcher non-printable">
	                			<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                  				<form action="/out_go_deliver/comment/<?php echo $out_go['id']?>" method="POST" id="form-submit" class="form-div span12" accept-charset="utf-8">
	                    				<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="data-content">
	    				<p class="centered">The Out Going Delivery Report has been created by <?php echo $item['del_name'];?> at <?php echo $item['timestamp'];?></p>
	    			</div>				
	    		</div>
			</div>
		</div>
