        ...
        <div class="container">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <fieldset>
              ...
              <?php endif ?>
              <a href="<?= base_url(); ?>s_rate/no_sr/" class="btn btn-warning">No Special rate</a>
            ...
            <tr id="item-1">
                          ...
                          <td class="centered" style="width: 200px;"> 
                            <input type="text" class="form-control" name="items[1][type]"  id="item-1-type" style="width: 200px; height:35px;"/></input>
                          </td>
                          <td class="centered" style="width: 200px;"> 
                            <input type="text" class="form-control" name="items[1][rate]"  id="item-1-rate" style="width: 200px; height:35px;"/></input>
                          </td>
                          <td class="centered" style="width: 200px;"> 
                            <input type="text" class="form-control" name="items[1][agent]"  id="item-1-agent" style="width: 200px; height:35px;"/></input>
                          </td>
                          <td class="centered" style="width: 200px;"> 
