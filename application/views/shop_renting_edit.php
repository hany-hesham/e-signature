              ...
              <form action="" method="POST" id="form-submit" enctype="multipart/form-data" class="form-div span12" accept-charset="utf-8">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      ...
                      <tbody>
                        <tr style="display: none;">
                          ...
                          <?php foreach ($offers as $offer): ?>
                            <td>
                              <input type="number" class="form-control" name="items[<?php echo $offer['id'] ?>][id]" value="<?php echo $offer['id'] ?>" /></input>
                            </td>
                          <?php endforeach;?>
                        </tr>
                        <tr style="display: none;">
                        ...
                        <tr>
                          ...
                          <?php foreach ($offers as $offer): ?>
                            <td>
                              <input type="radio" class="form-control" name="choosen_id" value="<?php echo $offer['id'] ?>"  
                              <?php if($shop['changes'] == 1){ 
                                if($offer['id'] == $shop['change_choosen_id']){ ?> 
                                  checked="checked" 
                                <?php } 
                              }else{
                                if($offer['id'] == $shop['choosen_id']){ ?> 
                                  checked="checked" 
                                <?php }
                              }?>/></input>
                            </td>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <input type="text" class="form-control" name="recommendation" placeholder="Recommendation ..." value="<?php echo $shop['recommendation'] ?>" style="width: 450px; height:33px;"/></input>
                  </div>
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <br>
                    <label for="from-hotel" class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label" style="margin-top:5px;">Reason</label>
                    <textarea type="text" name="reason" class="form-control" rows="3" placeholder="Reason..." style="width: 650px;"><?php echo $shop['reason'] ?></textarea>
                  </div>
