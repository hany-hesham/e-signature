...
<html lang="en">
    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse" id="forms-subnav" style="margin-left: 50px;">
        <ul class="nav navbar-nav navbar-left navbar-user">
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'financial')? 'active' : '' ?>"><a href="/gate/index">All</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'financial')? 'active' : '' ?>"><a href="/gate/index/2">Approved</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'financial')? 'active' : '' ?>"><a href="/gate/index/1">Waiting Approval</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'financial')? 'active' : '' ?>"><a href="/gate/index/3">Rejected</a></li>
        </ul>
      </nav>
      <div id="page-wrapper">
        <a href="<?php echo base_url(); ?>gate/submit/" class="btn btn-info">New Gate Pass Form</a>
        ...
        <table class="table table-bordered table-hover table-striped tablesorter">
          <thead>
            <tr>
              ...
              <th class="header">Position<i class="fa fa-sort"></i></th>
          ...
          <tbody>
            <?php foreach($gates as $gate ){?>
              <tr class="active">
                ...
                <td><?php echo $gate['hotel_name'] ?></td>
                <td><?php echo $gate['date'] ?></td>
                <td><?php echo $gate['name'] ?></td>
                <td><?php echo $gate['position'] ?></td>
                <td><?php echo $gate['department'] ?></td>
                <td>
                  <a href="<?php echo base_url(); ?>gate/view/<?php echo $gate['id'] ?> " class="btn btn-primary" style="width: 80px;">View</a>
                </td>
                <td style="width: 200px;">
                  <?php foreach ($gate['approvals'] as $approval): ?>
  ...
  <script type="text/javascript">
    $(function(){
      ...
      .find(".tablesorter-filter-row td:last input").replaceWith('<a href="<?php echo base_url(); ?>gate/" class="reset-filters btn btn-warning">Reset</a>');
    });
  </script>
</html>
