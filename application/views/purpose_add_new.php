            ...
            <fieldset>
              ...
              <form action="" method="POST" id="form-submit" enctype="multipart/form-data" class="form-div span12" accept-charset="utf-8">
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <textarea type="text" name="set" class="form-control" style="width:700px; height:100px;"></textarea>
                  ...
                  <input type="text" name="charged" class="form-control" style=" width: 240px; margin:20px;" class="form-control"/>
                  ...
                  <input type="text" name="position" class="form-control" style=" width: 240px; margin:20px;" class="form-control"/>
                  ...
                  <input type="text" name="area" class="form-control" style=" width: 240px; margin:20px;" class="form-control"/>
                  ...
                  <input type="text" name="amount" class="form-control" style=" width: 240px; margin:20px;" class="form-control"/>
                  <label for="from-hotel" class="col-lg-2 col-md-2 col-sm-2 col-xs-2  control-label " style ="width: 180px;"> Penalty</label>
                  <input type="text" name="penalty" class="form-control" style=" width: 240px; margin:20px;" class="form-control"/>
                </div>
