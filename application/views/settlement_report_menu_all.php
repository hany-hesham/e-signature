<form action="" method="POST" id="form-submit" class="form-div span12 non-printable" accept-charset="utf-8" enctype="multipart/form-data">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 non-printable">
		<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
			<select class="form-control" name="state" id="state">
				...
				<option <?php echo set_select('state', 2); ?> value="2">Approved</option>
				<option <?php echo set_select('state', 3); ?> value="3">Rejected</option>
				<option <?php echo set_select('state', 1); ?> value="1">Waiting approval</option>
				<option <?php echo set_select('state', 4); ?> value="4">Waiting approval from Chairman</option>
				<option <?php echo set_select('state', 5); ?> value="5">Closed Cases</option>
			</select>
		</div>
	</div>
	<br/>
