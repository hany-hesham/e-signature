    	...
    	<style type="text/css">
			@media print{
				@page { 
  				...
  				.hany{
  					background-color: #18AFBA !important; 
    	...
    	<div id="wrapper">
      		...
      		<div id="page-wrapper">
              	<div class="page-header" style="margin-top: 80px;">
					...
					<?php if ($is_editor): ?>
						<a class="form-actions btn btn-info non-printable" href="/policy/edit/<?php echo $core['id'] ?>" style="float:right;" > Edit </a>
					<?php endif ?>
					<div class="header-logo"><img src="/assets/uploads/logos/SR-Master.png"/></div>
		            <h1 class="centered" style="font-family: helvatica;">
		            	<?php foreach ($signers as $signer){
		            			if (isset($signer['sign']) && $signer['sign']['id'] == 217){
						     		$date = $signer['sign']['timestamp']; 
						    	} 
							} 
							if (isset($date)){
					            $dates = explode(" ",$date);
				        ...
				        ?>
		            	Signature Policy (لائحة التوقيعات) No. <?php echo $core['id'] ?><?php if (isset($datessss)):?> (<?php echo $datessss; ?>) <?php endif; ?>
		            </h1>
					...
					<a class="form-actions btn btn-success non-printable" href="/policy" style="float:right;"> Back </a>
					<table class="table table-striped table-bordered table-condensed" style="font-family: helvatica;">
                      	<tr>
		                    ...
		                    <td class="hanys" colspan="1" style=" text-align: center; color: gray;">Eighth Signature</td>
		                    <td class="hanys" colspan="1" style=" text-align: center; color: gray;">Ninth Signature</td>
                      	</tr>
                    	<tbody>
                      		<?php foreach ($departments as $department): ?>
                        		<tr>
                          			<td colspan="10" class="centered hany" style="background-color:#18AFBA !important; color: white;">
                        		...
                        		<?php foreach ($department['types'] as $type): ?>
                          			<tr>
                            			...
                            			<td class="centered" style=" width: 150px !important;"> 
                            				<div class="signer unsigned"><?php echo $type['policy']['role_eighth']?></div>
                            			</td>
                            			<td class="centered" style=" width: 150px !important;"> 
                            				<div class="signer unsigned"><?php echo $type['policy']['role_ninth']?></div>
                            			</td>
                          			</tr>
                        		<?php endforeach ?>
                      		<?php endforeach ?>
