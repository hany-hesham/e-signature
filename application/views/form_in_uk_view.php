          ...
          <div class="a4page">
            <div class="page-header">
              ...
              <?php if ($role_id == 58 || $role_id == 54 || $role_id == 47 || $role_id == 46 || $role_id == 42 || $role_id == 41 || $is_admin): ?>
                <a class="form-actions btn btn-info non-printable" href="/form/edit_in_uk/<?php echo $form['id'] ?>" style="float:right;" > Edit </a>
              <?php endif ?>
              <div class="header-logo"><img src="/assets/uploads/logos/<?php echo $form['logo']; ?>"/></div>
                ...
                <h3 class="centered">
                  In House Incident Report-UK Form No. #<?php echo $form['id']; ?>
                  <a class="form-actions btn btn-danger non-printable" href="/form/index_in_uk" style="float:right;" > Back </a>
                </h3>
              </div>
              ...
              <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <label for="from-type" class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label " style="margin:5px; width:500px;"><?php echo $form['irf']; ?></label>
                  <div class="non-printable centered form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <?php foreach ($log as $loger):?>
                      <?php if ($loger['location'] == "irf") { ?>
                        <?php $value = json_decode($loger['data']);?>
                        <span style="color: blue; font-size: 12px;"><?php echo $loger['action'] ?> By <?php echo $loger['name'] ?> at <?php echo $loger['timestamp'] ?> from "<span style="color: red;"><?php echo $value->old ?></span>" to "<span style="color:green; "><?php echo $value->new ?></span>".</span>
                        <br>
                      <?php } ?>
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <label for="from-type" class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label " style="margin:5px; width:500px;"><?php echo $form['address']; ?></label>
                  <div class="non-printable centered form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <?php foreach ($log as $loger):?>
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <label for="from-type" class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label " style="margin:5px; width:500px;"><?php echo $form['postcode']; ?></label>
                  <div class="non-printable centered form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <?php foreach ($log as $loger):?>
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <label for="from-type" class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label " style="margin:5px; width:500px;"><?php echo $form['email']; ?></label>
                  <div class="non-printable centered form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <?php foreach ($log as $loger):?>
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <label for="from-type" class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label " style="margin:5px; width:500px;"><?php echo $form['type']; ?></label>
                  <div class="non-printable centered form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <?php foreach ($log as $loger):?>
              ...
              <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <label for="from-type" class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label " style="margin:5px; width:500px;"><?php echo $form['address1']; ?></label>
                  <div class="non-printable centered form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <?php foreach ($log as $loger):?>
                      <?php if ($loger['location'] == "address1") { ?>
                        <?php $value = json_decode($loger['data']);?>
                        <span style="color: blue; font-size: 12px;"><?php echo $loger['action'] ?> By <?php echo $loger['name'] ?> at <?php echo $loger['timestamp'] ?> from "<span style="color: red;"><?php echo $value->old ?></span>" to "<span style="color:green; "><?php echo $value->new ?></span>".</span>
                        <br>
                      <?php } ?>
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <label for="from-type" class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label " style="margin:5px; width:500px;"><?php echo $form['telephone']; ?></label>
                  <div class="non-printable centered form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <?php foreach ($log as $loger):?>
                      <?php if ($loger['location'] == "telephone") { ?>
                        <?php $value = json_decode($loger['data']);?>
                        <span style="color: blue; font-size: 12px;"><?php echo $loger['action'] ?> By <?php echo $loger['name'] ?> at <?php echo $loger['timestamp'] ?> from "<span style="color: red;"><?php echo $value->old ?></span>" to "<span style="color:green; "><?php echo $value->new ?></span>".</span>
                        <br>
                      <?php } ?>
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <label for="from-type" class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label " style="margin:5px; width:500px;"><?php echo $form['email1']; ?></label>
                  <div class="non-printable centered form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <?php foreach ($log as $loger):?>
                      <?php if ($loger['location'] == "email1") { ?>
                        <?php $value = json_decode($loger['data']);?>
                        <span style="color: blue; font-size: 12px;"><?php echo $loger['action'] ?> By <?php echo $loger['name'] ?> at <?php echo $loger['timestamp'] ?> from "<span style="color: red;"><?php echo $value->old ?></span>" to "<span style="color:green; "><?php echo $value->new ?></span>".</span>
                        <br>
                      <?php } ?>
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <label for="from-type" class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label " style="margin:5px; width:500px;"><?php echo $form['indemnity']; ?></label>
                  <div class="non-printable centered form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <?php foreach ($log as $loger):?>
                      <?php if ($loger['location'] == "indemnity") { ?>
                        <?php $value = json_decode($loger['data']);?>
                        <span style="color: blue; font-size: 12px;"><?php echo $loger['action'] ?> By <?php echo $loger['name'] ?> at <?php echo $loger['timestamp'] ?> from "<span style="color: red;"><?php echo $value->old ?></span>" to "<span style="color:green; "><?php echo $value->new ?></span>".</span>
                        <br>
                      <?php } ?>
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <label for="from-hotel" class="col-lg-2 col-md-2 col-sm-2 col-xs-2  control-label " style="margin:5px; width: 500px;"><?php echo $form['value']; ?></label>
                  <div class="non-printable centered form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <?php foreach ($log as $loger):?>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 data-catcher non-printable">
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <form action="/form/comment_in_uk/<?php echo $form['id']?>" method="POST" id="form-submit" class="form-div span12" accept-charset="utf-8">
                    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="data-content">
              <?php if ($form['new_user_id']==0) {?>
                <p class="centered">In House Incident Report-UK Form has been created by <?php echo $form['name'];?> at <?php echo $form['timestamp'];?></p>
              <?php }else {?>
                <p class="centered">In House Incident Report-UK Form has been created by <?php echo $form['name'];?> at <?php echo $form['timestamp'];?></p>
