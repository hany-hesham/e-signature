    ...
    <table class="table table-bordered table-hover table-striped tablesorter">
      ...
      <?php foreach ($projects as $project): ?>
        <tr class="active <?php echo $project['progress_name'].'-row'; ?>">
          ...
          <td><?php echo ($project['new_date'] == '0000-00-00')? "":$project['new_date']; ?></td>
          <td>
          ...
          <?php else: ?>
            <a href="<?php echo base_url(); ?>project_progress/update/<?php echo $project['code'] ?>" class="btn btn-danger">Update</a>
            <a href="<?php echo base_url(); ?>projects/view/<?php echo $project['code'] ?>" class="btn btn-primary">View</a>
          <?php endif ?>
          </td>
        </tr>
