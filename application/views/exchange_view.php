       			...
       			<button onclick="myFunction();" class="non-printable form-actions btn btn-success" href="" >Print</button>
					<div class="a4wrapper">
						<div class="a4page">
							...
							<?php if ($is_editor): ?>
								<a class="form-actions btn btn-info non-printable" href="/exchange/edit/<?php echo $exchange['id'] ?>" style="float:right;" > Edit </a>
							<?php endif ?>
								...
								<a class="form-actions btn btn-info non-printable" href="/exchange/view_rate/<?php echo $exchange['id'] ?>" style="float:left; margin-left: 20px;" > View Bank Rate </a>
								<a class="form-actions btn btn-info non-printable" href="/exchange/mailme/<?php echo $exchange['id'] ?>" style="float:left; margin-left: 20px;" > <img src="/assets/images/letter.png" style="width: 28px; height: 40px; margin: 0px; margin-left: -10px; margin-top: -10px; margin-bottom: -10px;"> Share by Email </a>
								<a data-text="whatsapp" data-link="<?php echo base_url(); ?>exchange/view/<?php echo $exchange['id'] ?>" style="float:left; margin-left: 20px;" class="whatsapp whatsapp_btn whatsapp_btn_small form-actions btn btn-success non-printable"> <img src="/assets/images/original.png" style="width: 70px; height: 50px; margin: -20px; margin-left: -30px; margin-top: -21px;"> Share by Whatsapp</a>
								<!--<a data-text="whatsapp" style="float:left; margin-left: 20px;" class="form-actions btn btn-info non-printable" href="intent://send/0123456789#Intent;scheme=smsto;package=com.whatsapp;action=android.intent.action.SENDTO;end">Share</a>-->
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 data-catcher centered">
				                	...
				                	<div class="signature-wrapper">
				                    		...
				                    		<div class="expander-wrapper">
				                      			...
				                      			<div class="expander">
				                        			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 data-holder">
				                          				<div class="row">
				                            				<form action="/exchange/mailto/<?php echo $exchange['id']; ?>" method="POST" id="form-submit" class="form-div span12" accept-charset="utf-8">
			                  			...
			                  			" alt="<?php echo $signer['sign']['name']; ?>" class="img-rounded sign-image">
				                    		...
				                    		<a href="/exchange/unsign/<?php echo $signe_id; ?>" class="non-printable btn btn-primary unsign">Cancel</a>
				                    		<?php endif ?>
				                  		</div>
				                  		...
				                  		<div class="data-content non-printable"><span class="data-label sign-data-content"></span><a href="/exchange/sign/<?php echo $signe_id; ?>/reject" class="non-printable btn btn-danger">Reject</a><a href="/exchange/sign/<?php echo $signe_id; ?>" class="non-printable btn btn-success">sign</a></div>
				                  		<?php else: ?>
				                  		<?php $queue_first = FALSE; ?>
				                  		<?php endif ?>
				                	</div>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 data-catcher non-printable">
	                				<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                  					<form action="/exchange/comment/<?php echo $exchange['id']?>" method="POST" id="form-submit" class="form-div span12" accept-charset="utf-8">
	                    					<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
