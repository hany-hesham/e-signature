	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 non-printable">
	    ...
	    <div class="col-lg-offset-3 col-lg-3 col-md-6 col-md-offset-3 col-sm-3 col-sm-offset-3 col-xs-3 col-xs-offset-3">
				<select class="form-control" name="state" id="state">
					...
					<option value="1">Waiting approval from Bright Sky FC </option>
					<option value="2">Waiting approval from Bright Sky CEO </option>
					<option value="3">Waiting approval from FC Cairo Office </option>
					<option value="4">Waiting approval from Chairman </option>
				</select>
			</div>
	</div>
	<BR/><BR/>
