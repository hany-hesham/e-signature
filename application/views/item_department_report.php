				...
				<div class="container">
					<div class="rest-selector col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<fieldset class="non-printable">
							<legend class="title-table">Plan Department Report</legend>
							<?php $this->load->view('department_report_menu'); ?>
						</fieldset>
					</div>
					...
					<?php if (isset($app)): ?>	
						...
						<br>
						<br>
							<legend class="title-table" >Plan Department Report in Year <?php echo $year ?> for Department <?php echo $department['0']['name'] ?> for All Hotels</legend>
						</fieldset>
