          ...
          <div class="a4page" style="margin-bottom: 20px;">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 10px;">
              ...
              <div class="page-header">
                <h3>In House Incident Report-UK Form</h3>
              </div>
            </div>
            <form action="" method="POST" id="form-submit" enctype="multipart/form-data" class="form-div span12" accept-charset="utf-8">
              ...
              <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <input type="text" name="irf" class="form-control" style=" height:38px; width: 30%;"/>
                </div>
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <input type="text" name="address1" class="form-control" style=" height:38px; width: 30%; margin: 15px;"/>
                </div>
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <input type="text" name="telephone" class="form-control" style=" height:38px; width: 30%; margin: 15px;"/>
                </div>
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <label for="from-hotel" class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label " style="margin:5px; width: 200px;"> Email </label>
                  <input type="text" name="email1" class="form-control" style=" height:38px; width: 30%; margin: 15px;"/>
                </div>
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <input type="hidden" name="assumed_id1" value="<?php echo $assumed_id1; ?>" />
                  ...
                  <script>
                    $("#offers").fileinput({
                      uploadUrl: "/form/make_offer_in_uk/<?php echo $assumed_id1; ?>/1",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers1").fileinput({
                      uploadUrl: "/form/make_offer_in_uk1/<?php echo $assumed_id1; ?>/2",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers2").fileinput({
                      uploadUrl: "/form/make_offer_in_uk2/<?php echo $assumed_id1; ?>/3",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers3").fileinput({
                      uploadUrl: "/form/make_offer_in_uk3/<?php echo $assumed_id1; ?>/4",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers4").fileinput({
                      uploadUrl: "/form/make_offer_in_uk4/<?php echo $assumed_id1; ?>/5", 
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers5").fileinput({
                      uploadUrl: "/form/make_offer_in_uk5/<?php echo $assumed_id1; ?>/6",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
              ...
              <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers6").fileinput({
                      uploadUrl: "/form/make_offer_in_uk6/<?php echo $assumed_id1; ?>/7",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers7").fileinput({
                      uploadUrl: "/form/make_offer_in_uk7/<?php echo $assumed_id1; ?>/8",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers8").fileinput({
                      uploadUrl: "/form/make_offer_in_uk8/<?php echo $assumed_id1; ?>/9",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers9").fileinput({
                      uploadUrl: "/form/make_offer_in_uk9/<?php echo $assumed_id1; ?>/10",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers10").fileinput({
                      uploadUrl: "/form/make_offer_in_uk10/<?php echo $assumed_id1; ?>/11",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers11").fileinput({
                      uploadUrl: "/form/make_offer_in_uk11/<?php echo $assumed_id1; ?>/12",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers12").fileinput({
                      uploadUrl: "/form/make_offer_in_uk12/<?php echo $assumed_id1; ?>/13", 
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
              ...
              <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers13").fileinput({
                      uploadUrl: "/form/make_offer_in_uk13/<?php echo $assumed_id1; ?>/14",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
              ...
              <div style="    margin-top: 90px;" class="form-group">
                <div class="col-lg-offset-3 col-lg-10 col-md-10 col-md-offset-3">
                  ...
                  <a href="<?= base_url(); ?>form/index_in_uk" class="btn btn-warning">Cancel</a>
                </div>
              </div>
            </form>
          </div>
