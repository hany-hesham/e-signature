    	...
    	<div id="wrapper">
      		...
      		<div id="page-wrapper">
              	<div class="page-header">
					<a class="form-actions btn btn-success non-printable" href="/madar_policy/view/<?php echo $core['id'] ?>" style="float:left;" > view </a>
					<?php if ($is_request): ?>
        				<a href="<?php echo base_url(); ?>madar_policy_request/submit/" class="btn btn-info" style="float:right;">New Signature Policy Change Request</a>
        			<?php endif ?>
					<?php if ($is_admin || $madar_admin): ?>
						<a class="form-actions btn btn-info non-printable" href="/madar_policy/submit" style="float:right;" > Add New </a>
						<a class="form-actions btn btn-info non-printable" href="/madar_policy/submit_type" style="float:right;" > Add New Type </a>
						<a class="form-actions btn btn-info non-printable" href="/madar_policy/submit_department" style="float:right;" > Add New Department </a>
					<?php endif ?>
					<br>
					<br>
