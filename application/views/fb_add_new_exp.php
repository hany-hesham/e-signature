                ...
                <table class="table table-striped table-bordered table-condensed">
                  ...
                  <?php foreach ($items as $item):?>
                      <tr class="item-row">
                        ...
                        <td class="align-left table-label">
                          <input type="text" name="rooms[<?php echo $item['id']?>][guest]" class="form-control" value="" style="width: 100px;"/>
                        </td>
                        <td class="align-left table-label">
                          <input type="text" name="rooms[<?php echo $item['id']?>][nationality]" class="form-control" value="" style="width: 100px;"/> 
                        </td>
                        <td class="align-left table-label">
