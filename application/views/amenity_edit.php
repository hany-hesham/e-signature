          ...
          <div class="a4page">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 10px;">
              <div class="page-header">
                <h1 class="centered">Edit Guest Amenity Request</h1>
              </div>
                ...
                <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                  ...
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0" style="display: none;">
                      ...
                      <input type="text" name="rooms[<?php echo $item['id']?>][guest]" class="form-control"   value="<?php echo $item['guest']; ?>" style="width: 250px; height:33px;"/>
                    </div>
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0" style="display: none;">
                      <br>
                      ...
                      <input type="text" name="rooms[<?php echo $item['id']?>][nationality]" class="form-control" value="<?php echo $item['nationality']; ?>" style="width: 250px; height:33px;"/> 
                    </div>
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0" style="display: none;">
                      <br>
                      <label for="from-hotel" class="col-lg-2 col-md-2 col-sm-2 col-xs-2  control-label " style="margin-top:5px;"> Arrival Date </label>
                      <input type="text" name="rooms[<?php echo $item['id']?>][arrival]" class="form-control" value="<?php echo $item['arrival']; ?>" style="width: 250px; height:33px;"/>
                    </div>
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0" style="display: none;">
                      <br>
                      <label for="from-hotel" class="col-lg-2 col-md-2 col-sm-2 col-xs-2  control-label " style="margin-top:5px;"> Departure Date </label>
                      <input type="text" name="rooms[<?php echo $item['id']?>][departure]" class="form-control" value="<?php echo $item['departure']; ?>" style="width: 250px; height:33px;"/>
                    </div>
                    <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                      <br>
