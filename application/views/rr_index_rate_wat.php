  ...
  <body>
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse" id="forms-subnav">
        <ul class="nav navbar-nav navbar-left navbar-user">
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'frontoffice')? 'active' : '' ?>"><a href="/rr_change/index_rate">All</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'frontoffice')? 'active' : '' ?>"><a href="/rr_change/index_rate_app">Approved</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'frontoffice')? 'active' : '' ?>"><a href="/rr_change/index_rate_wat">Waiting Approval</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'frontoffice')? 'active' : '' ?>"><a href="/rr_change/index_rate_rej">Rejected</a></li>
        </ul>
      </nav>
        <div id="page-wrapper">
          <a href="<?php echo base_url(); ?>rr_change/submit/" class="btn btn-info">New Room Change Report</a>
          <br>
          <br>
          <div class="rest-selector col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <fieldset>
              <?php $this->load->view('rr_waiting_menu'); ?>
            </fieldset>
          </div>
          <?php if (isset($state)): ?> 
            <?php if ($state == 0) {   ?>
          ...
          <tbody>
            ...
            <tr class="active">
              ...
              <td>
                ...
                <?php endforeach ?>
                <?php }else{  ?>
                <h5 style="font-weight: bold;">NO ROOM/RATE REPORT</h5>
                <?php } ?>
              </td>
              <td><a href="<?php echo base_url(); ?>rr_change/view/<?php echo $forma['id'] ?> " class="btn btn-primary">View</a></td>
              <td>
    ...
    <script type="text/javascript">
      $(function(){
        ...
        .find(".tablesorter-filter-row td:last input").replaceWith('<a href="<?php echo base_url(); ?>rr_change/" class="reset-filters btn btn-warning">Reset</a>');
      });
    </script>
  </body>
</html>
