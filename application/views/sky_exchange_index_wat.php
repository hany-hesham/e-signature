  ...
  <body>
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse" id="forms-subnav" style=" margin-left: 50px;">
        <ul class="nav navbar-nav navbar-left navbar-user" style="width: 370px;">
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'rating')? 'active' : '' ?>"><a href="/sky_exchange">All</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'rating')? 'active' : '' ?>"><a href="/sky_exchange/index_app">Approved</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'rating')? 'active' : '' ?>"><a href="/sky_exchange/index_wat">Waiting Approval</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'rating')? 'active' : '' ?>"><a href="/sky_exchange/index_rej">Rejected</a></li>
        </ul>
      </nav>
        <div id="page-wrapper">
          <a href="<?php echo base_url(); ?>sky_exchange/add/" class="btn btn-info">New Daily Exchange Rate</a>
          <br>
          <br>
          <div class="rest-selector col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <fieldset>
              <?php $this->load->view('sky_exchange_waiting_menu'); ?>
            </fieldset>
          </div>
          <?php if (isset($state)): ?> 
            <?php if ($state == 0) {   ?>
        ...
        <table class="table table-bordered table-hover table-striped tablesorter">
          ...
          <tbody>
            ...
            <tr class="active">
              ...
              <td>
                <a href="<?php echo base_url(); ?>sky_exchange/view/<?php echo $forma['id'] ?> " class="btn btn-primary" style="width: 80px;">View</a>
              </td>
    ...
    <script type="text/javascript">
      $(function(){
        ...
        .find(".tablesorter-filter-row td:last input").replaceWith('<a href="<?php echo base_url(); ?>sky_exchange/" class="reset-filters btn btn-warning">Reset</a>');
      });
    </script>
  </body>
</html>
