<form action="" method="POST" id="form-submit" class="form-div span12" accept-charset="utf-8" enctype="multipart/form-data">
	<?php if (isset($no_role) && $no_role): ?>
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
				<select class="form-control" name="role" id="role">
					<option value="">Select Role</option>
					<option <?php echo set_select('role', 0); ?> value="0">All</option>
					<option <?php echo set_select('role', 17); ?> value="17">RGM Approval</option>
					<option <?php echo set_select('role', 3); ?> value="3">R.D.O.F Approval</option>
					<option <?php echo set_select('role', 16); ?> value="16">Managing Directore Approval</option>
					<option <?php echo set_select('role', 2); ?> value="2">Chairman Approval</option>
				</select>
			</div>
		</div>
		<br>
		<br>
	<?php endif ?>
	<?php if (isset($no_hotels) && $no_hotels): ?>
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
