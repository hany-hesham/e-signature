       			...
       			<button onclick="window.print()" class="non-printable form-actions btn btn-success" href="" >Print</button>
					<div class="a4wrapper">
						<div class="a4page">
							...
							<?php if ($is_editor): ?>
							<a class="form-actions btn btn-info non-printable" href="/discrepancy/edit/<?php echo $discrepancy['id'] ?>" style="float:right;" > Edit </a>
							<?php endif ?>
							    <div class="header-logo"><img src="/assets/uploads/logos/<?php echo $discrepancy['logo']; ?>"/></div>
                  				<h1 class="centered"><?php echo $discrepancy['hotel_name']; ?></h1>
								<h3 class="centered">
	        						Discrepancy Report No. #<?php echo $discrepancy['id']; ?>
	        					</h3>
	        					<div style="text-align: right;">
	        						<h3 style="margin-right: 80px;"><?php echo $discrepancy['time']; ?></h3>
	        						<h3 style="margin-right: 30px;"><?php echo $discrepancy['date']; ?></h3>
	        						<h3 style="margin-right: 50px;"><?php echo $discrepancy['dcy_type']; ?></h3>
	        					</div>
	        				</div>
							<table class="table table-striped table-bordered table-condensed">
								<tr class="item-row">
									<td class="align-left table-label" style="width: 100px;">Room</td>
									<td class="align-left table-label" style="width: 150px;">H.K</td>
									<td class="align-left table-label" style="width: 150px;">F.O</td>
									<td class="align-left table-label" style="width: 150px;">Re-check</td>
									<td class="align-left table-label" style="width: 450px;">Remarks</td>
								</tr>
								...
								<tr class="item-row">
									...
									<td class="align-left table-label" style="width: 150px;"><?php echo $room['h_k']?></td>
									<td class="align-left table-label" style="width: 150px;"><?php echo $room['f_o']?></td>
									<td class="align-left table-label" style="width: 150px;"><?php echo $room['re_check']?></td>
									<td class="align-left table-label" style="width: 450px;"><?php echo $room['remarks']?></td>
								</tr>
							<?php endforeach?>
							<?php }else{ ?>
								<img src="<?php echo base_url(); ?>assets/images/Capture4.png" style="position: absolute; margin-top: 100px; margin-left:140px; ">
									<?php for ($i=0; $i < 10; $i++) { ?>
								<tr class="item-row">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 data-catcher centered">
			                	...
			                	<div class="signature-wrapper">
			                    		...
			                    		<div class="expander-wrapper">
			                      			...
			                      			<div class="expander">
			                        			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 data-holder">
			                          				<div class="row">
			                            				<form action="/discrepancy/mailto/<?php echo $discrepancy['id']; ?>" method="POST" id="form-submit" class="form-div span12" accept-charset="utf-8">
			                  		...
			                  		<div class="data-content"><img src="<?php echo isset($signer['sign']['reject'])? $signature_path.'rejected.png' : $signature_path.'approved.png'; ?>" alt="<?php echo $signer['sign']['name']; ?>" class="img-rounded sign-image">
			                    		...
			                    		<a href="/discrepancy/unsign/<?php echo $signe_id; ?>" class="non-printable btn btn-primary unsign">Cancel</a>
			                    		<?php endif ?>
			                  		</div>
			                  		...
			                  		<div class="data-content non-printable"><span class="data-label sign-data-content"></span><a href="/discrepancy/sign/<?php echo $signe_id; ?>/reject" class="non-printable btn btn-danger">Reject</a><a href="/discrepancy/sign/<?php echo $signe_id; ?>" class="non-printable btn btn-success">sign</a></div>
			                  		<?php else: ?>
			                  		<?php $queue_first = FALSE; ?>
			                  		<?php endif ?>
			                	</div>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 data-catcher non-printable">
                				<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  					<form action="/discrepancy/comment/<?php echo $discrepancy['id']?>" method="POST" id="form-submit" class="form-div span12" accept-charset="utf-8">
                    					<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     						<textarea class="form-control" name="comment" id="comment"></textarea>
                    					</div>
                    					<input name="dcy_id" value="<?php echo $discrepancy['id']?>" type="hidden" />
                			...
                			<div class="data-content">
    							<p class="centered">The Food & Beverage Order has been created by <?php echo $discrepancy['name'];?> at <?php echo $discrepancy['timestamp'];?></p>
    						</div>
						</div>
					</div>
				</div>
