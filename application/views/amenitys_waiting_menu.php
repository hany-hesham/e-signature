<form action="" method="POST" id="form-submit" class="form-div span12" accept-charset="utf-8" enctype="multipart/form-data">
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 non-printable">
	    ...
	    <div class="col-lg-offset-3 col-lg-3 col-md-6 col-md-offset-3 col-sm-3 col-sm-offset-3 col-xs-3 col-xs-offset-3">
				<select class="form-control chooosen" name="state" data-placeholder="Signature ...">
					<option></option>
					<option value="1">Waiting approval from Resort Quality</option>
					<option value="4">Waiting approval from Front Office</option>
					<option value="5">Waiting approval from Food & Beverage </option>
					<option value="6">Waiting approval from Kitchen</option>
					<option value="7">Waiting approval from House Keeping</option>
					<option value="8">Waiting approval from Cost Controller</option>
				</select>
			</div>
	</div>
	<BR/><BR/>
