            ...
            <div class="container">
              <form action="" method="POST" id="form-submit" enctype="multipart/form-data" class="form-div span12" accept-charset="utf-8">
                ...
                <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-8">
                  ...
                  <script>
                    $("#offers").fileinput({
                      uploadUrl: "/madar_policy_request/upload/<?php echo $assumed_id; ?>",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      ...
                      initialPreviewConfig: [
                        <?php foreach($uploads as $upload): ?>
                          {url: "/madar_policy_request/remove/<?php echo $assumed_id ?>/<?php echo $upload['id'] ?>", key: "<?php echo $upload['name']; ?>"},
                        <?php endforeach; ?>
                      ],
                    });
                  </script>
