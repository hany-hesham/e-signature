...
<div id="wrapper">
	...
	<div class="container">
		...
		<?php if (isset($vip)): ?>	
			...
			<h1 class="centered topic" style="display: none;"> Amenities summary of Treatment <?php echo $treatment; ?> </h1>
			<h2 class="centered topic" style="display: none;"> from <?php echo $from; ?> to <?php echo $to; ?></h2>
			<h3 class="centered"> Total of <?php echo $vip_count; ?> Guest Amenities</h3>
			<br>
			<div class="centered">
