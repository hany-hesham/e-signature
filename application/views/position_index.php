...
<html lang="en">
  ...
  <body>
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <a href="<?php echo base_url(); ?>position/submit/" class="btn btn-info">New Hiring Position Request</a>
            ...
            <?php foreach($position as $forma ){?>
              <?php if ($forma['state_id'] !='0'){?>
                <tr class="active">
                  ...
                  <td>
                    <?php foreach ($forma['requests'] as $request):?>
                      <div class="">
                        <?php echo $request['position'] ?>
                      </div>
                    <?php endforeach ?>  
                  </td>
                  <td>
                    <a href="<?php echo base_url(); ?>position/view/<?php echo $forma['id'] ?> " class="btn btn-primary" style="width: 80px;">View</a>
                  </td>
    ...
    <script type="text/javascript">
      $(function(){
        ...
        .find(".tablesorter-filter-row td:last input").replaceWith('<a href="<?php echo base_url(); ?>position/" class="reset-filters btn btn-warning">Reset</a>');
      });
    </script>
  </body>
</html>