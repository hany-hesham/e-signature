...
<html lang="en">
  ...
  <body>
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <?php if ($is_request): ?>
          <a href="<?php echo base_url(); ?>policy_request/submit/" class="btn btn-info">New Signature Policy Change Request</a>
        <?php endif ?>
          ...
          <tbody>
            <?php foreach($policy_requests as $request ){?>
              <tr class="active">
                ...
                <td>
                  <a href="<?php echo base_url(); ?>policy_request/view/<?php echo $request['id'] ?> " class="btn btn-primary" style="width: 80px;">View</a>
                </td>
              </tr>
            <?php } ?>
          </tbody>
  ...
  <script type="text/javascript">
    $(function(){
      ...
      .find(".tablesorter-filter-row td:last input").replaceWith('<a href="<?php echo base_url(); ?>policy_request/" class="reset-filters btn btn-warning">Reset</a>');
    });
  </script>
</html>
