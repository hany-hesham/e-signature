...
<html lang="en">
    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse" id="forms-subnav" style="margin-left: 50px;">
        <ul class="nav navbar-nav navbar-left navbar-user">
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'madars')? 'active' : '' ?>"><a href="/transfer/index">All</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'madars')? 'active' : '' ?>"><a href="/transfer/index_app">Approved</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'madars')? 'active' : '' ?>"><a href="/transfer/index_wat">Waiting Approval</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'madars')? 'active' : '' ?>"><a href="/transfer/index_rej">Rejected</a></li>
        </ul>
      </nav>
      <div id="page-wrapper">
        <a href="<?php echo base_url(); ?>transfer/submit/" class="btn btn-info">New Payment Plan Form</a>
        ...
        <div class="rest-selector col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <fieldset>
            <?php $this->load->view('transfer_waiting_menu'); ?>
          </fieldset>
        </div>
        <?php if (isset($state)): ?>
        ...
        <table class="table table-bordered table-hover table-striped tablesorter">
          <thead>
            <tr>
              ...
              <th class="header">التاريخ<i class="fa fa-sort"></i></th>
              <th class="header">الحساب المحول<i class="fa fa-sort"></i></th>
              <th class="header">الحساب المحول إليه<i class="fa fa-sort"></i></th>
          ...
          <tbody>
            <?php foreach($transfer as $tran ){?>
              <tr class="active">
                ...
                <td><?php echo $tran['from_acc'] ?></td>
                <td><?php echo $tran['to_acc'] ?></td>
                <td>
                  <a href="<?php echo base_url(); ?>transfer/view/<?php echo $tran['id'] ?> " class="btn btn-primary" style="width: 80px;">View</a>
                </td>
                <td style="width: 200px;">
                  <?php foreach ($tran['approvals'] as $approval): ?>
  ...
  <script type="text/javascript">
    $(function(){
      ...
      .find(".tablesorter-filter-row td:last input").replaceWith('<a href="<?php echo base_url(); ?>transfer/" class="reset-filters btn btn-warning">Reset</a>');
    });
  </script>
</html>
