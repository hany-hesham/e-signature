       			...
       			<button onclick="window.print()" class="non-printable form-actions btn btn-success" href="" >Print</button>
					<div class="a4wrapper">
						<div class="a4page">
							...
							<?php if ($is_editor): ?>
							<a class="form-actions btn btn-info non-printable" href="/rra_change/edit/<?php echo $rr['id'] ?>" style="float:right;" > Edit </a>
							<?php endif ?>
							    <div class="header-logo"><img src="/assets/uploads/logos/<?php echo $rr['logo']; ?>"/></div>
                  				<h1 class="centered"><?php echo $rr['hotel_name']; ?></h1>
								<h3 class="centered">
	        						Rate Change Report No. #<?php echo $rr['id']; ?>
	        					</h3>
                    		...
                    		<?php if ($rra_room) {?>
								<?php foreach ($rra_room as $room):?>
									<tr class="item-row">
										<td class="align-left table-label" style="width: 150px;"><?php echo $room['room_old']?></td>
										<td class="align-left table-label" style="width: 150px;"><?php echo $room['room_new']?></td>
										<td class="align-left table-label" style="width: 150px;"><?php echo $room['rate_from']?> <?php echo $room['currency']; ?></td>
										<td class="align-left table-label" style="width: 150px;"><?php echo $room['rate_to']?> <?php echo $room['currency']; ?></td>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 data-catcher centered">
			                	...
			                	<div class="signature-wrapper">
			                    		...
			                    		<div class="expander-wrapper">
			                      			...
			                      			<div class="expander">
			                        			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 data-holder">
			                          				<div class="row">
			                            				<form action="/rra_change/mailto/<?php echo $rr['id']; ?>" method="POST" id="form-submit" class="form-div span12" accept-charset="utf-8">
			                  		...
			                  		<div class="data-content"><img src="<?php echo isset($signer['sign']['reject'])? $signature_path.'rejected.png' : $signature_path.'approved.png'; ?>" alt="<?php echo $signer['sign']['name']; ?>" class="img-rounded sign-image">
			                    		...
			                    		<a href="/rra_change/unsign/<?php echo $signe_id; ?>" class="non-printable btn btn-primary unsign">Cancel</a>
			                    		<?php endif ?>
			                  		</div>
			                  		...
			                  		<div class="data-content non-printable"><span class="data-label sign-data-content"></span><a href="/rra_change/sign/<?php echo $signe_id; ?>/reject" class="non-printable btn btn-danger">Reject</a><a href="/rra_change/sign/<?php echo $signe_id; ?>" class="non-printable btn btn-success">sign</a></div>
			                  		<?php else: ?>
			                  		<?php $queue_first = FALSE; ?>
			                  		<?php endif ?>
			                	</div>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 data-catcher non-printable">
                				<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  					<form action="/rra_change/comment/<?php echo $rr['id']?>" method="POST" id="form-submit" class="form-div span12" accept-charset="utf-8">
                    					<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                			...
                			<div class="data-content">
    							<p class="centered">The Rate Change Report has been created by <?php echo $rr['name'];?> at <?php echo $rr['timestamp'];?></p>
    						</div>
						</div>
					</div>
				</div>
