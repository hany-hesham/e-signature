...
<html lang="en">
    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse" id="forms-subnav" style="margin-left: 50px;">
        <ul class="nav navbar-nav navbar-left navbar-user">
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'reserve')? 'active' : '' ?>"><a href="/credit_app/index">All</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'reserve')? 'active' : '' ?>"><a href="/credit_app/index/2">Approved</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'reserve')? 'active' : '' ?>"><a href="/credit_app/index/12">Waiting Approval</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'reserve')? 'active' : '' ?>"><a href="/credit_app/index/3">Rejected</a></li>
        </ul>
      </nav>
      <div id="page-wrapper">
        <a href="<?php echo base_url(); ?>credit_app/submit/" class="btn btn-info">New Credit Application Form</a>
        ...
        <table class="table table-bordered table-hover table-striped tablesorter">
          <thead>
            <tr>
              ...
              <th class="header">Bank Name<i class="fa fa-sort"></i></th>
          ...
          <tbody>
            <?php foreach($credits_app as $credit ){?>
              <tr class="active">
                ...
                <td>
                  <a href="<?php echo base_url(); ?>credit_app/view/<?php echo $credit['id'] ?> " class="btn btn-primary" style="width: 80px;">View</a>
                </td>
  ...
  <script type="text/javascript">
    $(function(){
      ...
      .find(".tablesorter-filter-row td:last input").replaceWith('<a href="<?php echo base_url(); ?>credit_app/" class="reset-filters btn btn-warning">Reset</a>');
    });
  </script>
  <script type="text/javascript">
    document.body.addEventListener("keydown", function (event) {
      if (event.keyCode === 13) {
        window.location.replace("<?= base_url(); ?>credit_app/submit");
      }
    });  
  </script>
</html>
