    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse" id="forms-subnav">
        <ul class="nav navbar-nav navbar-left navbar-user">
          ...
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'quality')? 'active' : '' ?>"><a href="/settlements/index_close">Closed Cases</a></li>
        </ul>
      </nav>
        <div id="page-wrapper">
        ...
        <table class="table table-bordered table-hover table-striped tablesorter">
          ...
          <tbody>
            <?php foreach($settlements as $forma ){?>
              <?php if ($forma['state_id'] !='0' && ( $forma['claim_status'] == "Closed")) :?>
           <tr class="active">
