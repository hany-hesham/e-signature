  ...
  <body>
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <div class="a4wrapper">
          <div class="a4page">
            <a href="<?= base_url(); ?>fb_order/add_exp/" class="form-actions btn btn-info" style="float:left;">Expacted Arrival</a>
            ...
            <div class="container">
              <form action="" method="POST" id="form-submit" enctype="multipart/form-data" class="form-div span12" accept-charset="utf-8">
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <label for="from-hotel" class="col-lg-2 col-md-2 col-sm-2 col-xs-2  control-label " style="margin-top:5px;"> Room </label>
                    <input type="text" class="form-control" name="room" style="width: 240px; height:34px;"/>
                  </div>
                </div>
