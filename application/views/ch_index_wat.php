  ...
  <body>
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse" id="forms-subnav" style=" margin-left: 50px;">
        <ul class="nav navbar-nav navbar-left navbar-user" style="width: 370px;">
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'frontoffice')? 'active' : '' ?>"><a href="/late_ch">All</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'frontoffice')? 'active' : '' ?>"><a href="/late_ch/index_app">Approved</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'frontoffice')? 'active' : '' ?>"><a href="/late_ch/index_wat">Waiting Approval</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'frontoffice')? 'active' : '' ?>"><a href="/late_ch/index_rej">Rejected</a></li>
        </ul>
      </nav>
        <div id="page-wrapper">
          <a href="<?php echo base_url(); ?>late_ch/submit/" class="btn btn-info">New Late check out Report</a>
          <br>
          <br>
          <div class="rest-selector col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <fieldset>
              <?php $this->load->view('ch_waiting_menu'); ?>
            </fieldset>
          </div>
          <?php if (isset($state)): ?> 
            <?php if ($state == 0) {   ?>
          ...
          <tbody>
            ...
            <tr class="active">
              ...
              <?php foreach ($forma['items'] as $item): ?>
                ...
                <?php endforeach ?>
                <?php }else{  ?>
                <h5 style="font-weight: bold;">NO LATE CHECK OUT</h5>
                <?php } ?>
              </td>
              <td>
                <?php if ($forma['items']) { ?>
              ...
              <td><a href="<?php echo base_url(); ?>late_ch/view/<?php echo $forma['id'] ?> " class="btn btn-primary">View</a></td>
              <td>
                ...
                <div class="signer unsigned"><?php echo ($approval['role_id'] == 7)? $approval['department'] : $approval['role']; ?></div>
                <?php endif ?>
                <?php endforeach ?>
              </td>
              <?php } ?>
    ...
    <script type="text/javascript">
      $(function(){
        ...
        .find(".tablesorter-filter-row td:last input").replaceWith('<a href="<?php echo base_url(); ?>late_ch/" class="reset-filters btn btn-warning">Reset</a>');
      });
    </script>
  </body>
</html>
