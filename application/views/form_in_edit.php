          ...
          <div class="a4page" style="margin-bottom: 20px;">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 10px;">
              ...
              <div class="page-header">
                <h3>Edit In House - other nationalities Incident Report Form</h3>
              </div>
            </div>
            <form action="" method="POST" id="form-submit" enctype="multipart/form-data" class="form-div span12" accept-charset="utf-8">
              ...
              <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <input type="text" name="tl" class="form-control" value="<?php echo $form['tl']; ?>" style=" height:38px; width: 30%;"/>
                </div>
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <input type="text" name="booking" class="form-control" value="<?php echo $form['booking']; ?>" style=" height:38px; width: 30%;"/>   
                </div>
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <select id="select_get_type" name="visited" for="from-hotel" class="col-lg-2 col-md-2 col-sm-2 col-xs-2  control-label form-control" style="width: 30%; margin-top: 18px;">
                    <option value="<?php echo $form['visited']; ?>"></option>
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers").fileinput({
                      uploadUrl: "/form/make_offer_in/<?php echo $form['id'] ?>/1",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers1").fileinput({
                      uploadUrl: "/form/make_offer_in1/<?php echo $form['id'] ?>/2",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers2").fileinput({
                      uploadUrl: "/form/make_offer_in2/<?php echo $form['id'] ?>/3",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers3").fileinput({
                      uploadUrl: "/form/make_offer_in3/<?php echo $form['id'] ?>/4",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers4").fileinput({
                      uploadUrl: "/form/make_offer_in4/<?php echo $form['id'] ?>/5",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
              ...
              <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <select id="select_get_type" name="added" for="from-hotel" class="col-lg-2 col-md-2 col-sm-2 col-xs-2  control-label form-control" style="width: 30%;">
                    <option value=""><?php echo $form['added']; ?></option>
                    <option value="Yes">Yes</option>
                    <option value="No">No</option>
                    <option value="In progress">In progress</option>
                  </select>
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <select id="select_get_type" name="accepted" for="from-hotel" class="col-lg-2 col-md-2 col-sm-2 col-xs-2  control-label form-control" style="width: 30%;">
                    <option value="<?php echo $form['accepted']; ?>"></option>
                    <option value="Yes">Yes</option>
                    <option value="No">No</option>
                    <option value="In progress">In progress</option>
                  </select>
              ...
              <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers5").fileinput({
                      uploadUrl: "/form/make_offer_in5/<?php echo $form['id'] ?>/6",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers6").fileinput({
                      uploadUrl: "/form/make_offer_in6/<?php echo $form['id'] ?>/7",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers7").fileinput({
                      uploadUrl: "/form/make_offer_in7/<?php echo $form['id'] ?>/8",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers8").fileinput({
                      uploadUrl: "/form/make_offer_in8/<?php echo $form['id'] ?>/9",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers9").fileinput({
                      uploadUrl: "/form/make_offer_in9/<?php echo $form['id'] ?>/10",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers10").fileinput({
                      uploadUrl: "/form/make_offer_in10/<?php echo $form['id'] ?>/11",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers11").fileinput({
                      uploadUrl: "/form/make_offer_in11/<?php echo $form['id'] ?>/12",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <script>
                    $("#offers12").fileinput({
                      uploadUrl: "/form/make_offer_in12/<?php echo $form['id'] ?>/13",
                      uploadAsync: true,
                      minFileCount: 1,
                      maxFileCount: 100,
                      overwriteInitial: false,
              ...
              <div style="    margin-top: 90px;" class="form-group">
                <div class="col-lg-offset-3 col-lg-10 col-md-10 col-md-offset-3">
                  ...
                  <a href="<?= base_url(); ?>form/view_in/<?php echo $form['id']; ?>" class="btn btn-warning">Cancel</a>
                </div>
              </div>
            </form>
          </div>
