              ...
              <form action="" method="POST" id="form-submit" enctype="multipart/form-data" class="form-div span12" accept-charset="utf-8">
                <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                  ...
                  <div class='input-group date' id='datetimepicker1' style="width: 250px; height:33px;">
                    <input type='text' class="form-control" name="date" value="<?php echo $transfer['date'] ?>" readonly="readonly"/>
                ...
                <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                  ...
                  <input type="text" class="form-control" name="from_acc"  value="<?php echo $transfer['from_acc'] ?>" readonly="readonly" style="width: 250px; height:33px;"/></input>
                </div>
                <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                  <br>
                  ...
                  <input type="text" class="form-control" name="to_acc"  value="<?php echo $transfer['to_acc'] ?>" readonly="readonly" style="width: 250px; height:33px;"/></input>
                </div>
                ...
                <div style="    margin-top: 90px;" class="form-group">
                  <div class="col-lg-offset-3 col-lg-10 col-md-10 col-md-offset-3">
                    ...
                    <a href="<?= base_url(); ?>transfer/edit/<?php echo $transfer['id'] ?>" class="btn btn-warning">Cancel</a>
                  </div>
                </div>
              </form>
            </div>
