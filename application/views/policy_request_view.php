          			...
          			<div class="a4page">
            			<div>
              				<div class="page-header">
								...
								<?php if ($is_editor): ?>
									<a class="form-actions btn btn-info non-printable" href="/policy_request/edit/<?php echo $request['id'] ?>" style="float:right;" > Edit </a>
								<?php endif ?>
			        			<h2 class="centered">
			        				Signature Policy Change Request No. #<?php echo $request['id']; ?>
			        			</h2>
								<a class="form-actions btn btn-success non-printable" href="/policy_request" style="float:right;"> Back </a>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 data-catcher non-printable">
	                			<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                  				<form action="/policy_request/comment/<?php echo $request['id']?>" method="POST" id="form-submit" class="form-div span12" accept-charset="utf-8">
	                    				<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
