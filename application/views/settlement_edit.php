              ...
              <form action="" method="POST" id="form-submit" enctype="multipart/form-data" class="form-div span12" accept-charset="utf-8">
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <select class="form-control" name="hotel_id" id="from-hotel " style="width: 30%;">
                    <option data-company="0" value="<?php echo $settlement['hotel_id']; ?>"><?php echo $settlement['hotel_name']; ?></option>
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <p>
                    <input type="text" name="amount" class="form-control" style=" height:38px; width: 240px;" class="form-control" value="<?php echo $settlement['amount']; ?>"/>
                    <br>
                  <select class="form-control" name="currency" style="height:35px; width: 240px; margin-left: 148px;">
                            <option value="<?php echo $settlement['currency']; ?>"><?php echo $settlement['currency']; ?></option>
                            <option value="£">£</option> ‎
                            <option value="$">$</option>
                  ...
                  <div class='input-group date' id='datetimepicker11' style=" width: 240px; margin:10px;">
                    <input type="text" name="Date" class="form-control" value="<?php echo $settlement['Date']; ?>" /> 
                  ...
                  <div class='input-group date' id='datetimepicker10' style=" width: 240px; margin:10px;">
                    <input type="text" name="Date_till" class="form-control" value="<?php echo $settlement['Date_till']; ?>" /> 
                    <span class="input-group-addon"><span class="glyphicon glyphicon-calender"></span></span>
                  </div>
                  <label for="from-hotel" class="col-lg-2 col-md-2 col-sm-2 col-xs-2  control-label " style="margin-top:5px;"> File Name </label>
                  <p>
                    <input type="text" name="File" class="form-control" style=" height:38px; width: 240px;" class="form-control" value="<?php echo $settlement['File']; ?>"/>
                  </p>
                  <label for="from-hotel" class="col-lg-2 col-md-2 col-sm-2 col-xs-2  control-label " style="margin-top:5px;"> Booking Ref</label>
                  <p>
                    <input type="text" name="Ref" class="form-control" style=" height:38px; width: 240px;" value="<?php echo $settlement['Ref']; ?>"/>
                  </p>
                  <label for="from-hotel" class="control-label " style="margin-top:5px;"> Nature of Claim </label>
                  <p>
                    <textarea type="text" name="Claim" class="form-control" style=" width: 800px; height:100px;" ><?php echo $settlement['Claim']; ?></textarea>
                  </p>
                  <label for="from-hotel" class="ontrol-label " style="margin-top:5px;" > Proposed settlement </label>
                  <p>
                    <textarea type="text" name="Proposed" class="form-control" style=" width: 800px; height:100px;" ><?php echo $settlement['Proposed']; ?></textarea>
                  </p>                  
                  <label for="from-hotel" class="control-label " style="margin-top:5px;"> Rationale for Proposed settlement </label>
                  <p>
                    <textarea type="text" name="Rationale" class="form-control" style=" width: 800px; height:100px;" ><?php echo $settlement['Rationale']; ?></textarea>
                  </p>                  
                  <label for="from-hotel" class="control-label " style="margin-top:5px;"> Potential Risk if Proposed settlement Declined </label>
                  <p>
                    <textarea type="text" name="Risk" class="form-control" style=" width: 800px; height:100px;"><?php echo $settlement['Risk']; ?></textarea>
                  </p>                  
                  <label for="from-hotel" class="control-label " style="margin-top:5px;"> Proposed settlement Rejected by</label>
                  <p>
                    <textarea type="text" name="Rejected" class="form-control" style=" width: 800px; height:100px;"><?php echo $settlement['Rejected']; ?></textarea>
                  </p>
                  <label for="from-hotel" class="control-label " style="margin-top:5px;" > Reason of Rejection</label>
                  <p>
                    <textarea type="text" name="Reason" class="form-control" style=" width: 800px; height:100px;" ><?php echo $settlement['Reason']; ?></textarea>
                  </p>                  
                  ...
                  <p>
                    <textarea type="text" name="Suggestion" class="form-control" style=" width: 800px; height:100px;"><?php echo $settlement['Suggestion']; ?></textarea>
                  </p>
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <input type="hidden" name="set_id" value="<?php echo $settlement['id']; ?>" />
                      ...
                      <script>
                      $("#offers").fileinput({
                          uploadUrl: "/settlement/make_offer/<?php echo $settlement['id'] ?>", // server upload action
                          uploadAsync: true,
                          minFileCount: 1,
                          maxFileCount: 5,
                  ...
                  <p>
                    <textarea type="text" name="Agreed" class="form-control" style=" width: 800px; height:100px;"> <?php echo $settlement['Agreed']; ?></textarea>
                  </p>  
                </div>
