          ...
          <div class="a4page">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 10px;">
                <div class="page-header">
                  <h1 class="centered">Edit Chairman Monthly Report</h1>
                </div>
                  ...
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      ...
                      <div class='input-group date ' id='datetimepicker1' style=" width: 240px;">
                        <input type="text" name="date" class="form-control" value="<?php echo $char['date']; ?>" /> 
                    ...
                    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      ...
                      <input type="text" name="file" class="form-control" value="<?php echo $char['file']; ?>" style=" width: 240px;"/> 
                    </div>
                    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12" style=" width: 740px;">
                      ...
                      <label class="col-lg-2 col-md-6 col-sm-2 col-xs-2  control-label " style="margin-top:15px;"> Report Files</label>
                      ...
                      <script>
                        $("#offers").fileinput({
                          uploadUrl: "/char_report/make_offer/<?php echo $char['id']; ?>", // server upload action
                          uploadAsync: true,
                          minFileCount: 1,
                          maxFileCount: 5,
                          ...
                          initialPreviewConfig: [
                            <?php foreach($uploads as $upload): ?>
                              {url: "/char_report/remove_offer/<?php echo $char['id']; ?>/<?php echo $upload['id']; ?>", key: "<?php echo $upload['name']; ?>"},
                            <?php endforeach; ?>
                          ],
                        });
                      </script>
