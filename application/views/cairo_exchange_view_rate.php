		...
		<div id="wrapper" style="margin-left: 50px;">
			...
			<div id="page-wrapper">
       			<button onclick="myFunction();" class="non-printable form-actions btn btn-success" href="" >Print</button>
					<div class="">
						<div class=" col-md-6" id="a4page">
							<div class="page-header">
							<?php if ($is_editor): ?>
								<a class="form-actions btn btn-info non-printable" href="/cairo_exchange/edit/<?php echo $exchange['id'] ?>" style="float:right;" > Edit </a>
							<?php endif ?>
								...
								<a class="form-actions btn btn-info non-printable" href="/cairo_exchange/view/<?php echo $exchange['id'] ?>" style="float:left; margin-left: 20px;" > Hide Bank Rate </a>
								<br>
								<br>
								<a class="form-actions btn btn-info non-printable" href="/cairo_exchange/mailme/<?php echo $exchange['id'] ?>" style="float:left; margin-left: 20px;" > <img src="/assets/images/letter.png" style="width: 28px; height: 40px; margin: 0px; margin-left: -10px; margin-top: -10px; margin-bottom: -10px;"> Share by Email </a>
								<br>
								<br>
								<a data-text="whatsapp" data-link="<?php echo base_url(); ?>cairo_exchange/view/<?php echo $exchange['id'] ?>" style="float:left; margin-left: 20px;" class="whatsapp whatsapp_btn whatsapp_btn_small form-actions btn btn-success non-printable"> <img src="/assets/images/original.png" style="width: 70px; height: 50px; margin: -20px; margin-left: -30px; margin-top: -21px;"> Share by Whatsapp</a>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 data-catcher centered">
				                	...
				                	<div class="signature-wrapper">
				                    		...
				                    		<div class="expander-wrapper">
				                      			...
				                      			<div class="expander">
				                        			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 data-holder">
				                          				<div class="row">
				                            				<form action="/cairo_exchange/mailto/<?php echo $exchange['id']; ?>" method="POST" id="form-submit" class="form-div span12" accept-charset="utf-8">
				                  		...
				                  		<div class="data-content"><img src="<?php echo isset($signer['sign']['reject'])? $signature_path.'rejected.png' : ($signer['sign']['name'] == 'Hossam El Shaer')? $signature_path.'9f3a8-mr.-hossam.jpg' : $signature_path.'approved.png'; ?>" alt="<?php echo $signer['sign']['name']; ?>" class="img-rounded sign-image">
				                    		...
				                    		<a href="/cairo_exchange/unsign/<?php echo $signe_id; ?>" class="non-printable btn btn-primary unsign">Cancel</a>
				                    		<?php endif ?>
				                  		</div>
				                  		...
				                  		<div class="data-content non-printable"><span class="data-label sign-data-content"></span><a href="/cairo_exchange/sign/<?php echo $signe_id; ?>/reject" class="non-printable btn btn-danger">Reject</a><a href="/cairo_exchange/sign/<?php echo $signe_id; ?>" class="non-printable btn btn-success">sign</a></div>
				                  		<?php else: ?>
				                  		<?php $queue_first = FALSE; ?>
				                  		<?php endif ?>
				                	</div>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 data-catcher non-printable">
	                				<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                  					<form action="/cairo_exchange/comment/<?php echo $exchange['id']?>" method="POST" id="form-submit" class="form-div span12" accept-charset="utf-8">
	                    					<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
