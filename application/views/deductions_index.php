        ...
        <table class="table table-bordered table-hover table-striped tablesorter">
          <thead>
            <tr>
              ...
              <th class="header">Comments<i class="fa fa-sort"></i></th> 
              <th class="header">Amount of Deduction<i class="fa fa-sort"></i></th> 
              <th class="header">Date of Recieving Deductions<i class="fa fa-sort"></i></th>
              <th class="header" style="width: 300px;">Subject of Deductions<i class="fa fa-sort"></i></th>
            ...
            <?php foreach($deductions as $forma ){?>
              <?php if ($forma['guest'] != NULL && $forma['state_id'] !='0'){?>
                <tr class="active">
                  ...
                  <td><?php echo $forma['comment'] ?></td>
                  <td><?php echo $forma['amount'] ?> <?php echo $forma['curency'] ?></td>
