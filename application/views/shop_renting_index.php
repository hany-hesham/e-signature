...
<html lang="en">
    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse" id="forms-subnav" style="margin-left: 50px;">
        <ul class="nav navbar-nav navbar-left navbar-user">
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'financial')? 'active' : '' ?>"><a href="/shop_renting/index">All</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'financial')? 'active' : '' ?>"><a href="/shop_renting/index/2">Approved</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'financial')? 'active' : '' ?>"><a href="/shop_renting/index/10">Done</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'financial')? 'active' : '' ?>"><a href="/shop_renting/index/12">Waiting Approval</a></li>
          <li class="<?php echo (isset($submenu['active']) && $submenu['active'] == 'financial')? 'active' : '' ?>"><a href="/shop_renting/index/3">Rejected</a></li>
        </ul>
      </nav>
      <div id="page-wrapper">
        <a href="<?php echo base_url(); ?>shop_renting/submit/" class="btn btn-info">New Shop Renting Prior Approval Form</a>
        ...
        <table class="table table-bordered table-hover table-striped tablesorter">
          <thead>
            <tr>
              ...
              <th class="header">Change<i class="fa fa-sort"></i></th>
          ...
          <tbody>
            <?php foreach($shops as $shop ){?>
              <tr class="active">
                ...
                <td><?php echo $shop['hotel_name'] ?></td>
                ...
                <td>
                  <a href="<?php echo base_url(); ?>shop_renting/view/<?php echo $shop['id'] ?> " class="btn btn-primary" style="width: 80px;">View</a>
                </td>
                <td style="width: 200px;">
                  <?php foreach ($shop['approvals'] as $approval): ?>
  ...
  <script type="text/javascript">
    $(function(){
      ...
      .find(".tablesorter-filter-row td:last input").replaceWith('<a href="<?php echo base_url(); ?>shop_renting/" class="reset-filters btn btn-warning">Reset</a>');
    });
  </script>
  <script type="text/javascript">
    document.body.addEventListener("keydown", function (event) {
      if (event.keyCode === 13) {
        window.location.replace("<?= base_url(); ?>shop_renting/submit");
      }
    });  
  </script>
</html>
