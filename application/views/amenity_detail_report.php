...
<div id="wrapper">
	...
	<div class="container">
		<div class="rest-selector col-lg-12 col-md-12 col-sm-12 col-xs-12 non-printable">
			<fieldset>
			<legend class="title-table">Amenity Details Report</legend>
					<?php $this->load->view('amenity_report_menu_all'); ?>
			</fieldset>
		</div>
		<?php if (isset($vip)): ?>	

			<h2 class="centered topic" style="display: none;"> Amenity Detail Report For All Hotels Treatment <?php echo $treatment; ?> </h2>
			<h3 class="centered topic" style="display: none;"> from <?php echo $from; ?> to <?php echo $to; ?></h3>
			<h4 class="centered"> Total of <?php echo $vip_count; ?> Guest Amenities</h4>
			<div class="centered">
				<table class="table table-striped table-bordered table-condensed summary" style="width: 200px; font-size:9px; float: right;">
					<tr>
						<td>Hotel Name</td>
						<td>No. of Reports</td>
					</tr>
			...
			<div class="centered">
						...
						<?php foreach ($vip as $re): ?>
							...
							<?php endif ?>
						<?php endforeach ?>
				<table class="table table-striped table-bordered table-condensed real" style="width:800px; position: relative; float: left;">
					<tbody>
						<tr>
