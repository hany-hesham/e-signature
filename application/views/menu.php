<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse" >
    <ul class="nav navbar-nav side-nav" style="font-size: 12px; width: 110px">
      <?php if ((isset($user_id)) && ($user_id == 307)){ ?>
        ...
        <li class="<?php echo (isset($menu['active']) && $menu['active'] == 'design')? 'active' : '' ?>">
          <a href="/design">
            <i class="fa <?php echo (isset($menu['active']) && $menu['active']=='design')? 'fa-minus-square' : 'fa-plus-square'?>"></i>
                    Design
          </a>
        </li>
      <?php }elseif ((isset($user_id)) && ($user_id == 316 || $user_id == 317)){ ?>
      ...
      <?php }elseif (isset($role_id) && ($role_id == 12 || $role_id == 13 || $role_id == 81 || $role_id == 88 || $role_id == 94 || $role_id == 96 || $role_id == 114)){ ?>
      ...
      <?php }elseif (isset($role_id) && ($role_id == 57 || $role_id == 59)){ ?>
        <li class="<?php echo (isset($menu['active']) && $menu['active'] == 'financial')? 'active' : '' ?> dropdown">
          <a href="/financial">
            <i class="fa <?php echo (isset($menu['active']) && $menu['active'] == 'financial')? 'fa-minus-square' : 'fa-plus-square' ?>"></i>
            Financial
      ...
      <?php }elseif (isset($role_id) && ($role_id == 128 || $role_id == 132|| $role_id == 135)){ ?>
        <li class="<?php echo (isset($menu['active']) && $menu['active'] == 'madars')? 'active' : '' ?> dropdown">
          <a href="/madars">
            <i class="fa <?php echo (isset($menu['active']) && $menu['active'] == 'madars')? 'fa-minus-square' : 'fa-plus-square' ?>"></i>
            Madar
      ...
      <?php }elseif (isset($role_id) && ($role_id == 60 || $role_id == 61)){ ?>
        <li class="<?php echo (isset($menu['active']) && $menu['active'] == 'reserve')? 'active' : '' ?> dropdown">
          <a href="/reserve">
            <i class="fa <?php echo (isset($menu['active']) && $menu['active'] == 'reserve')? 'fa-minus-square' : 'fa-plus-square' ?>"></i>
            Reservation
      ...
      <?php }else{ ?>
        ...
        <?php }elseif (isset($is_claim) && $is_claim){ ?>
          <li class="<?php echo (isset($menu['active']) && $menu['active'] == 'quality')? 'active' : '' ?> dropdown">
            <a href="/quality">
              <i class="fa <?php echo (isset($menu['active']) && $menu['active'] == 'quality')? 'fa-minus-square' : 'fa-plus-square' ?>"></i>
              Quality
        ...
        <?php }elseif ((isset($is_corp) && $is_corp) || (isset($role_id) && ($role_id == 56)) || (isset($department_id) && ($department_id == 2))){ ?>
          <li class="<?php echo (isset($menu['active']) && $menu['active'] == 'forms')? 'active' : '' ?>">
  	        <a href="/forms">
  	          <i class="fa <?php echo (isset($menu['active']) && $menu['active'] == 'forms')? 'fa-arrow-circle-right' : 'fa-dot-circle-o'?>"></i>
  	          Assets Movement
         ...
         <?php }elseif (isset($is_cluster) && $is_cluster){ ?>
          <li class="<?php echo (isset($menu['active']) && $menu['active'] == 'forms')? 'active' : '' ?>">
            <a href="/forms">
              <i class="fa <?php echo (isset($menu['active']) && $menu['active'] == 'forms')? 'fa-arrow-circle-right' : 'fa-dot-circle-o'?>"></i>
              Assets Movement
        ...
        <?php }elseif (isset($is_rater) && $is_rater){ ?>
          <li class="<?php echo (isset($menu['active']) && $menu['active'] == 'forms')? 'active' : '' ?>">
  	        <a href="/forms">
  	          <i class="fa <?php echo (isset($menu['active']) && $menu['active'] == 'forms')? 'fa-arrow-circle-right' : 'fa-dot-circle-o'?>"></i>
  	          Assets Movement
        ...
        <?php }elseif (isset($is_cairo) && $is_cairo){ ?>
          <li class="<?php echo (isset($menu['active']) && $menu['active'] == 'rating')? 'active' : '' ?> dropdown">
            <a href="/rating">
              <i class="fa <?php echo (isset($menu['active']) && $menu['active'] == 'rating')? 'fa-minus-square' : 'fa-plus-square' ?>"></i>
              Exchange Rate
          ...
          <?php }elseif (isset($is_sky) && $is_sky) { ?>
          	<li class="<?php echo (isset($menu['active']) && $menu['active'] == 'rating')? 'active' : '' ?> dropdown">
              <a href="/rating">
                <i class="fa <?php echo (isset($menu['active']) && $menu['active'] == 'rating')? 'fa-minus-square' : 'fa-plus-square' ?>"></i>
                Exchange Rate
          ...
          <?php }elseif (isset($is_admin) && $is_admin) { ?>
          	<li class="<?php echo (isset($menu['active']) && $menu['active'] == 'forms')? 'active' : '' ?>">
  	            <a href="/forms">
  	                <i class="fa <?php echo (isset($menu['active']) && $menu['active'] == 'forms')? 'fa-arrow-circle-right' : 'fa-dot-circle-o'?>"></i>
  	                Assets Movement
          ...
          <?php }?>
        <?php }?>
        <?php if (((isset($user_id)) && ($user_id == 1)) || ((isset($user_id)) && ($user_id == 217)) || ((isset($user_id)) && ($user_id == 2)) || ((isset($user_id)) && ($user_id == 55)) || ((isset($user_id)) && ($user_id == 250))) {?>
      ...
      <!--<?php if (isset($counter)): ?>
        <li class="dropdown user-dropdown">
          <a href="/chairman_approval" class="dropdown-toggle top-sm-btn" data-toggle="dropdown">
            <i class="fa fa-globe fa-lg"></i><span class="circle" style="background-color: red; color: #ffffff; font-size: 18px; font-weight: bolder;"><?php echo $counter; ?></span></a>
            <ul class="dropdown-menu centerd" style="text-align: center; width: 200px;">
              <?php foreach($forms as $form ){?>
                <li><?php echo $form['state']['name'] ?><a href="<?php echo base_url(); ?><?php echo $form['state']['link'] ?><?php echo $form[$form['state']['variable']] ?>" class="btn btn-primary">View</a></li>
              <?php } ?>
            </ul>
        </li>
      <?php endif; ?>-->
