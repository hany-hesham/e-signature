...
<html lang="en">
          ...
          <div class="a4page" style="margin-bottom: 10px;">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 10px;">
              <div class="page-header">
                <h1 class="centered">New Design Request</h1>
              </div>
                ...
                <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                  ...
                  <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                    ...
                    <div class='input-group date' id='datetimepicker1' style="width: 250px; height:33px;">
                      <input type='text' class="form-control" name="date" placeholder="Date ..." value="<?php echo set_value('date'); ?>"/>
                  ...
                  <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                    ...
                    <select class="form-control chooosen" name="department_id" id="from-hotel " data-placeholder="Department ..." style="width: 250px; height:33px;">
                      <option data-company="0" value="">Department ..</option>
                  ...
                  <div class="col-lg-offset-0 col-lg-10 col-md-10 col-md-offset-0">
                    ...
                    <textarea class="form-control" name="outline" placeholder="Outline ..." style="width: 500px;" rows="3"><?php echo set_value('outline'); ?></textarea>
                  </div>
                  ...
                  <div class="form-group col-lg-10 col-md-10 col-sm-10 col-xs-10">
                    ...
                    <script>
                      $("#offers").fileinput({
                        uploadUrl: "/design_request/upload/<?php echo $assumed_id; ?>",
                        uploadAsync: true,
                        minFileCount: 1,
                        maxFileCount: 100,
                        ...
                        initialPreviewConfig: [
                          <?php foreach($uploads as $upload): ?>
                            {url: "/design_request/remove/<?php echo $assumed_id ?>/<?php echo $upload['id'] ?>", key: "<?php echo $upload['name']; ?>"},
                          <?php endforeach; ?>
                        ],
                      });
                    </script>
                  ...
                  <div style="margin-top: 90px;" class="form-group">
                    <div class="col-lg-offset-3 col-lg-10 col-md-10 col-md-offset-3">
                      ...
                      <a href="<?= base_url(); ?>design_request/" class="btn btn-warning">Cancel</a>
                    </div>
                  </div>
                </div>
              </form>
  ...
  <script type="text/javascript">
    document.body.addEventListener("keydown", function (event) {
      if (event.keyCode === 27) {
        window.location.replace("<?= base_url(); ?>design_request/");
      }
    });  
  </script>
</html>
