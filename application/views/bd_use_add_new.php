                  ...
                  <?php foreach ($items as $item):?>
                    <?php foreach($item['contacts'] as $contact):?>
                      <tr class="item-row">
                        ...
                        <td class="align-left table-label">
                          <input readonly="" type="text" name="rooms[<?php echo $item['id']?>][guest]" class="form-control" value="<?php echo $contact['guest_name']; ?>" required/>
                        </td>
                        <td class="align-left table-label">
                          <input readonly="" type="text" name="rooms[<?php echo $item['id']?>][nationality]" class="form-control" value="<?php echo $contact['nation']; ?>" required/> 
                        </td>
                        <td class="align-left table-label">
