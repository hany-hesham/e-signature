		...
		<div id="wrapper">
			...
			<div class="rest-selector col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<fieldset>
					...
					<?php $this->load->view('amenitys_type_report_menu_hotel'); ?>
				</fieldset>
			</div>
			<?php if (isset($type)): ?>	
				<div class="centered">
					...
					<?php if(isset($type['name']) && $type['name']){ ?>
						<h2 class="centered topic" style="display: none;"> Amenities Report For Type <?php echo $type['name']; ?></h2>
					<?php } ?>
