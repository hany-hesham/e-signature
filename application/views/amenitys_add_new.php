              ...
              <form action="" method="POST" id="form-submit" enctype="multipart/form-data" class="form-div span12" accept-charset="utf-8">
                  ...
                  <?php foreach ($items as $item):?>
                    <?php foreach($item['contacts'] as $contact):?>
                      <tr class="item-row">
                        ...
                        <td class="align-left table-label">
                          <input readonly="" type="text" name="rooms[<?php echo $item['id']?>][guest]" class="form-control" value="<?php echo $contact['guest_name']; ?>"/>
                        </td>
                        <td class="align-left table-label">
                          <input readonly="" type="text" name="rooms[<?php echo $item['id']?>][nationality]" class="form-control" value="<?php echo $contact['nation']; ?>"/> 
                        </td>
                        <td class="align-left table-label">
                          <input readonly="" type="text" name="rooms[<?php echo $item['id']?>][arrival]" class="form-control" value="<?php echo $contact['arriv']; ?>"/> 
                        </td>
                        <td class="align-left table-label">
                          <input readonly="" type="text" name="rooms[<?php echo $item['id']?>][departure]" class="form-control" value="<?php echo $contact['depart']; ?>"/> 
                        </td>
                        <td class="align-left table-label">
                          <input readonly="" type="number" name="rooms[<?php echo $item['id']?>][pax]" placeholder="No. Pax ..." class="form-control" value="<?php echo $contact['no_pax']; ?>"/> 
                        </td>
                        <td class="align-left table-label">
                          <input readonly="" type="number" name="rooms[<?php echo $item['id']?>][child]" placeholder="No. Child ..." class="form-control" value="<?php echo $contact['no_child']; ?>"/> 
                        </td>
                      </tr>
                    <?php endforeach ?>
                  <?php endforeach ?>
                ...
                <div style="    margin-top: 90px;" class="form-group">
                  <div class="col-lg-offset-3 col-lg-10 col-md-10 col-md-offset-3">
                    ...
                    <a href="<?= base_url(); ?>amenitys/add" class="btn btn-warning">Cancel</a>
                  </div>
                </div>
              </form>
            </div>
