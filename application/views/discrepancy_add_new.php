      ...
      <div id="page-wrapper">
        <div class="container">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <fieldset>
              <legend>Submit a new Discrepancy Report</legend>
              <?php if(validation_errors() != false): ?>
              <div class="alert alert-danger">
                <?php echo validation_errors(); ?>
              </div>
              <?php endif ?>
              <a href="<?= base_url(); ?>discrepancy/no_dcy/" class="btn btn-warning">No Discrepancy</a>
            ...
            <tr id="item-1">
                          ...
                          <td class="centered" style="width: 200px;"> 
                            <input type="text" class="form-control" name="items[1][h_k]"  id="item-1-h_k" style="width: 200px; height:35px;"/></input>
                          </td>
                          <td class="centered" style="width: 200px;"> 
                            <input type="text" class="form-control" name="items[1][f_o]"  id="item-1-f_o" style="width: 200px; height:35px;"/></input>
                          </td>
                          <td class="centered" style="width: 200px;"> 
                            <input type="text" class="form-control" name="items[1][re_check]"  id="item-1-re_check" style="width: 200px; height:35px;"/></input>
                          </td>
                          <td class="centered" style="width: 200px;"> 
        ...
        document.items = <?php echo json_encode($this->input->post('items')); ?>;
                  ...
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <script>
                      $("#offers").fileinput({
                        uploadUrl: "/discrepancy/make_offer/<?php echo $assumed_id; ?>", // server upload action
                        uploadAsync: true,
                        minFileCount: 1,
                        maxFileCount: 5,
                        ...
                        initialPreviewConfig: [
                          <?php foreach($uploads as $upload): ?>
                            {url: "/discrepancy/remove_offer/<?php echo $assumed_id; ?>/<?php echo $upload['id']; ?>", key: "<?php echo $upload['name']; ?>"},
                          <?php endforeach; ?>
                        ],
                      });
                    </script>
