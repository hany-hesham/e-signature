          ...
          <div class="" style="margin-left: -200px;">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 10px;">
              ...
              <?php foreach ($rooms as $room):?>
                <?php if(!isset($room['contacts'])): ?>
                  <div class="alert alert-danger" style="width: 80%;">
                    <?php echo "No Data For Such Hotel Room NO# ".$room['room']." !"; ?>
                  </div>
                <?php endif ?>
              <?php endforeach ?>
            </div>
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <table class="table table-striped table-bordered table-condensed">
                    ...
                    <tbody id="items-container" data-items="1">
                      <?php foreach ($rooms as $room):?>
                        <?php foreach($room['contacts'] as $contact):?>
                          <tr id="item-1">
                            ...
                            <td class="centered"> 
                              <input readonly="" type="text" class="form-control" name="rooms[<?php echo $room['id']?>][guest]" value="<?php echo $contact['guest']?>" style="width: 200px; height:33px;"/></input>
                            </td>
                            <td class="centered"> 
                            ...
                            <td class="centered"> 
                              <input readonly="" type="text" class="form-control" name="rooms[<?php echo $room['id']?>][arrival]" value="<?php echo $contact['arriv']?>" style="width: 100px; height:33px;"/></input>
                            </td>
                            <td class="centered"> 
                              <input readonly="" type="text" class="form-control" name="rooms[<?php echo $room['id']?>][departure]" value="<?php echo $contact['depart']?>" style="width: 100px; height:33px;"/></input>
                            </td>
                            <td class="centered"> 
                            ...
                            <td class="centered"> 
                              <input type="text" class="form-control" name="rooms[<?php echo $room['id']?>][occupancy]" style="width: 80px; height:33px;"/>%</input>
                            </td>
                            <td class="centered"> 
                              <input type="text" class="form-control" name="rooms[<?php echo $room['id']?>][arrival_room]" style="width: 80px; height:33px;"/></input>
                            </td>
                            <td class="centered"> 
                              <input type="text" class="form-control" name="rooms[<?php echo $room['id']?>][departure_room]" style="width: 80px; height:33px;"/></input>
                            </td>
                          </tr>
                        <?php endforeach ?>
                      <?php endforeach ?>
