...
/*	function is_corp()
	...
	*/
	...
	function is_corp()
	{
		return ( $this->ci->session->userdata('role') == 6 ||  $this->ci->session->userdata('role') == 17 || $this->ci->session->userdata('role') == 42 || $this->ci->session->userdata('role') == 41 || $this->ci->session->userdata('role') == 46 || $this->ci->session->userdata('role') == 58 || $this->ci->session->userdata('role') == 84 || $this->ci->session->userdata('user_id') == 343)? TRUE: FALSE;
	}

	function is_rater()
	{
		return ( $this->ci->session->userdata('role') == 1 || $this->ci->session->userdata('role') == 2 || $this->ci->session->userdata('role') == 3 || $this->ci->session->userdata('role') == 16 )? TRUE: FALSE;
	}

	function is_cairo()
	{
		return ($this->ci->session->userdata('role') == 44)? TRUE: FALSE;
	}

	function is_claim()
	{
		return ($this->ci->session->userdata('role') == 50)? TRUE: FALSE;
	}

	function is_cluster()
	{
		return ($this->ci->session->userdata('role') == 4)? TRUE: FALSE;
	}

	function is_sky()
	{
		return ($this->ci->session->userdata('role') == 45 || $this->ci->session->userdata('role') == 49)? TRUE: FALSE;
	}

	function is_fc()
	{
		return ($this->ci->session->userdata('role') == 5)? TRUE: FALSE;
	}

	function is_UK()
	{
		return ( $this->ci->session->userdata('role') == 47 ||  $this->ci->session->userdata('role') == 54)? TRUE: FALSE;
	}

	function isnt_UK()
	{
		return ( $this->ci->session->userdata('role') != 47)? TRUE: FALSE;
	}
